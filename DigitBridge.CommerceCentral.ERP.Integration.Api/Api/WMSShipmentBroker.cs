...
namespace DigitBridge.CommerceCentral.ERP.Integration.Api
{
    ...
    public static class WMSShipmentBroker
    {
        ...
        [OpenApiOperation(operationId: "CreateShipment", tags: new[] { "Shipments" }, Summary = "Add single WMS shipment to ERP")]
        ...
        public static async Task<JsonNetResponse<WmsOrderShipmentPayload>> CreateShipment(
        ...
        public static async Task<JsonNetResponse<IList<WmsOrderShipmentPayload>>> CreateShipmentList(
            [HttpTrigger(AuthorizationLevel.Function, "post", Route = "shipments/list")] HttpRequest req)
        {
