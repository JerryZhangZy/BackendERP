...
namespace DigitBridge.CommerceCentral.ERPApiSDK
{
    public class CommerceCentralAckProcessInvoiceClient : ApiClientBase<AcknowledgeProcessPayload>
    {
        ...
        /// </summary>
        public CommerceCentralAckProcessInvoiceClient() : base(ConfigUtil.ERP_Integration_Api_BaseUrl, ConfigUtil.ERP_Integration_Api_AuthCode)
        {
        ...
        public CommerceCentralAckProcessInvoiceClient(string baseUrl, string authCode) : base(baseUrl, authCode)
        { }


        /// <summary>
        /// Wms transfer invoice then ack process result to erp.
        /// </summary>
        /// <param name="masterAccountNum"></param>
        /// <param name="profileNum"></param>
        /// <param name="requestPayload"></param>
        /// <returns></returns>
        public async Task<bool> AckProcessInvoicesAsync(int masterAccountNum, int profileNum, IList<ProcessResult> processResults)
        {
            ...
            return await PostAsync(requestPayload, FunctionUrl.AckProcessInvoices);
        }
