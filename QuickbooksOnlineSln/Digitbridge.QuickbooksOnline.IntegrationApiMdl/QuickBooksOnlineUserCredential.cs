...
{
    public class QuickBooksOnlineUserCredential
    {
        ...
        private QuickBooksOnlineUserCredential(MsSqlUniversal msSql, QboDbConfig dbConfig, 
        ...
        public static async Task<QuickBooksOnlineUserCredential> CreateAsync(QboDbConfig dbConfig,
            QboConnectionConfig qboConnectionConfig, string requstState)
        {
            try
            {
                ...
                var quickBooksOnlineUserCredential =
                    new QuickBooksOnlineUserCredential(
        ...
        public async Task<(bool, string)> DisconnectUser()
        {
            try
            {
                ...
                List<QboIntegrationSetting> qboIntergrationSettings =
                    ComlexTypeConvertExtension.DatatableToList<QboIntegrationSetting>(settingTb);
                ...
                List<QboChnlAccSetting> qboChnlAccSettings =
                    ComlexTypeConvertExtension.DatatableToList<QboChnlAccSetting>(chnlSettingTb);
