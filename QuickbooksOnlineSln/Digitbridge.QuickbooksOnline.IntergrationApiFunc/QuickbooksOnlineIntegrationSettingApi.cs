...
{
    public static class QuickbooksOnlineIntegrationSettingApi
    {
            ...
            ILogger log, ExecutionContext context, ClaimsPrincipal claimsPrincipal)
        {
            ...
            try
            {
                ...
                QuickbooksOnlineIntegrationSetting integrationSetting =
                    await QuickbooksOnlineIntegrationSetting.CreateAsync(dbConfig, qboConnectionConfig, 
            ...
            ILogger log, ExecutionContext context, ClaimsPrincipal claimsPrincipal)
        {
            ...
            try
            {
                ...
                QuickbooksOnlineIntegrationSetting integrationSetting =
                    await QuickbooksOnlineIntegrationSetting.CreateAsync(
