...
namespace Digitbridge.QuickbooksOnline.CentralToDbFunc
{
    public class MyAppSetting
    {
        ...
        public string TimeTriggerEnQueueMasterAccountNumber
        {
            get
            {
                return _config["TimeTriggerEnQueueMasterAccountNumber"];
            }
        }
        public string TimeTriggerEnQueueProfileNumber
        {
            get
            {
                return _config["TimeTriggerEnQueueProfileNumber"];
            }
        }
    }
}
