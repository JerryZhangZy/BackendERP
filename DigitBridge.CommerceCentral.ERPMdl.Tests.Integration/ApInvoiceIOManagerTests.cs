...
namespace DigitBridge.CommerceCentral.ERPMdl.Tests.Integration
{
    ...
    /// </summary>
    public partial class ApInvoiceIOManagerTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        ...
        public ApInvoiceIOManagerTests(TestFixture<StartupTest> fixture)
        {
            Fixture = fixture;
        ...
        public async Task ImportCsvAsync_Test()
        {
            ...
            var service = new ApInvoiceIOManager(DataBaseFactory);
        ...
        public async Task ExportAsync_Test()
        {
            var fileName = "c:\\temp\\Dto_2.csv";
            var service = new ApInvoiceIOManager(DataBaseFactory);
            IList<ApInvoiceDataDto> dtos = new List<ApInvoiceDataDto>();
            var ApInvoiceService = new ApInvoiceService(DataBaseFactory);
            if (ApInvoiceService.List("9027ebbd-a022-434e-965d-adb20cc27dac"))
                dtos.Add(ApInvoiceService.ToDto());
            if (ApInvoiceService.List("117227d4-43cc-476c-9257-29695d08fdd1"))
                dtos.Add(ApInvoiceService.ToDto());
            if (ApInvoiceService.List("22da3dbb-6d02-4852-a2b8-04c380b36dd6"))
                dtos.Add(ApInvoiceService.ToDto());
