...
{
    public partial class SystemCodesServiceTests
    {
		...
		public void AddDto_Test()
		{
            ...
            var id = dto.SystemCodes.SystemCodeUuid;
...
");
            ...
            var data = GetFakerData();
            var dto = mapper.WriteDto(data, null);
            dto.SystemCodes.RowNum = rowNum;
            dto.SystemCodes.SystemCodeUuid = id;
...
");
            ...
            var payload = new SystemCodesPayload();
            payload.SystemCodes = dto;
            payload.MasterAccountNum = srv.Data.SystemCodes.MasterAccountNum;
            payload.ProfileNum = srv.Data.SystemCodes.ProfileNum;
            payload.DatabaseNum = srv.Data.SystemCodes.DatabaseNum;
