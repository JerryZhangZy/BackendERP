...
{
    public partial class InvoicePaymentSummaryTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        ...
        public InvoicePaymentSummaryTests(TestFixture<StartupTest> fixture)
        {
            Fixture = fixture;
        ...
        public async Task InvoicePaymentSummaryAsync_Test()
        {
            ...
            var qry = new InvoicePaymentSummaryQuery();
            var srv = new InvoicePaymentSummaryInquiry(dataBaseFactory, qry);

            StringBuilder sb = new StringBuilder();
            using (var b = new Benchmark("InvoicePaymentSummaryAsync"))
            {
                await srv.InvoicePaymentSummaryAsync(payload);
            }

            System.Diagnostics.Debug.WriteLine($"result is {payload.InvoicePaymentSummary}");
