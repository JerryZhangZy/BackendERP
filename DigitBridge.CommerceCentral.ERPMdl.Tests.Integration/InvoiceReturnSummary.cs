...
{
    public partial class InvoiceReturnSummaryTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        ...
        public InvoiceReturnSummaryTests(TestFixture<StartupTest> fixture)
        {
            Fixture = fixture;
        ...
        public async Task InvoiceReturnSummaryAsync_Test()
        {
            ...
            var qry = new InvoiceReturnSummaryQuery();
            var srv = new InvoiceReturnSummaryInquiry(dataBaseFactory, qry);

            StringBuilder sb = new StringBuilder();
            using (var b = new Benchmark("InvoiceReturnSummaryAsync"))
            {
                await srv.InvoiceReturnSummaryAsync(payload);
            }

            System.Diagnostics.Debug.WriteLine($"result is {payload.InvoiceReturnSummary}");
