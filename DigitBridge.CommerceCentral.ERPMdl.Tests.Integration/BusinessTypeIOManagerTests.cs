...
namespace DigitBridge.CommerceCentral.ERPMdl.Tests.Integration
{
    ...
    /// </summary>
    public partial class BusinessTypeIOManagerTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        ...
        public BusinessTypeIOManagerTests(TestFixture<StartupTest> fixture)
        {
            Fixture = fixture;
        ...
        public async Task ImportCsvAsync_Test()
        {
            ...
            var service = new BusinessTypeIOManager(DataBaseFactory);
            IList<BusinessTypeDataDto> data;
        ...
        public async Task ExportAsync_Test()
        {
            var fileName = "c:\\temp\\Dto_2.csv";
            var service = new BusinessTypeIOManager(DataBaseFactory);
            IList<BusinessTypeDataDto> dtos = new List<BusinessTypeDataDto>();
            var BusinessTypeService = new BusinessTypeService(DataBaseFactory);
            if (BusinessTypeService.List("9027ebbd-a022-434e-965d-adb20cc27dac"))
                dtos.Add(BusinessTypeService.ToDto());
            if (BusinessTypeService.List("117227d4-43cc-476c-9257-29695d08fdd1"))
                dtos.Add(BusinessTypeService.ToDto());
            if (BusinessTypeService.List("22da3dbb-6d02-4852-a2b8-04c380b36dd6"))
                dtos.Add(BusinessTypeService.ToDto());
