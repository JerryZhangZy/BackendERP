...
namespace DigitBridge.CommerceCentral.ERPMdl.Tests.Integration
{
    ...
    /// </summary>
    public partial class OrderShipmentIOManagerTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        ...
        public OrderShipmentIOManagerTests(TestFixture<StartupTest> fixture)
        {
            Fixture = fixture;
        ...
        public async Task ImportCsvAsync_Test()
        {
            ...
            var service = new OrderShipmentIOManager(DataBaseFactory);
        ...
        public async Task ExportAsync_Test()
        {
            var fileName = "c:\\temp\\Dto_2.csv";
            var service = new OrderShipmentIOManager(DataBaseFactory);
            IList<OrderShipmentDataDto> dtos = new List<OrderShipmentDataDto>();
            var OrderShipmentService = new OrderShipmentService(DataBaseFactory);
            if (OrderShipmentService.List("9027ebbd-a022-434e-965d-adb20cc27dac"))
                dtos.Add(OrderShipmentService.ToDto());
            if (OrderShipmentService.List("117227d4-43cc-476c-9257-29695d08fdd1"))
                dtos.Add(OrderShipmentService.ToDto());
            if (OrderShipmentService.List("22da3dbb-6d02-4852-a2b8-04c380b36dd6"))
                dtos.Add(OrderShipmentService.ToDto());
