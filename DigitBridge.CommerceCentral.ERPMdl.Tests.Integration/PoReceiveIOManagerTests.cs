...
namespace DigitBridge.CommerceCentral.ERPMdl.Tests.Integration
{
    ...
    /// </summary>
    public partial class PoReceiveIOManagerTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        ...
        public PoReceiveIOManagerTests(TestFixture<StartupTest> fixture)
        {
            Fixture = fixture;
        ...
        public async Task ImportCsvAsync_Test()
        {
            ...
            var service = new PoReceiveIOManager(DataBaseFactory);
            IList<PoTransactionDataDto> data;
        ...
        public async Task ExportAsync_Test()
        {
            var fileName = "c:\\temp\\Dto_2.csv";
            var service = new PoReceiveIOManager(DataBaseFactory);
            IList<PoTransactionDataDto> dtos = new List<PoTransactionDataDto>();
            var PoTransactionService = new PoTransactionService(DataBaseFactory);
            if (PoTransactionService.List("9027ebbd-a022-434e-965d-adb20cc27dac"))
                dtos.Add(PoTransactionService.ToDto());
            if (PoTransactionService.List("117227d4-43cc-476c-9257-29695d08fdd1"))
                dtos.Add(PoTransactionService.ToDto());
            if (PoTransactionService.List("22da3dbb-6d02-4852-a2b8-04c380b36dd6"))
                dtos.Add(PoTransactionService.ToDto());
