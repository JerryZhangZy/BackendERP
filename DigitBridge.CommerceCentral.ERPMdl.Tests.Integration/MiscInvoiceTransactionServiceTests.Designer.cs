...
{
    /// <summary>
    /// Represents a Tester for MiscInvoiceTransactionService.
    /// NOTE: This class is generated from a T4 template - you should not modify it manually.
    /// </summary>
    public partial class MiscInvoiceTransactionServiceTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        protected MiscInvoiceTransactionData GetFakerData()
        {
            return MiscInvoiceTransactionDataTests.GetFakerData();
        }

        protected List<MiscInvoiceTransactionData> GetFakerData(int count)
        {
            return MiscInvoiceTransactionDataTests.GetFakerData(count);
        }
        ...
        public MiscInvoiceTransactionServiceTests(TestFixture<StartupTest> fixture) 
        {
            Fixture = fixture;
...
");
            ...
            var srvGetById = new MiscInvoiceTransactionService(DataBaseFactory);
            srvGetById.List();
...
");
            ...
            var result = DataBaseFactory.ExistUniqueId<MiscInvoiceTransaction>(srv.Data.UniqueId);
