...
namespace DigitBridge.CommerceCentral.ERPMdl.Tests.Integration
{
    ...
    /// </summary>
    public partial class ShippingCodesIOManagerTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        ...
        public ShippingCodesIOManagerTests(TestFixture<StartupTest> fixture)
        {
            Fixture = fixture;
        ...
        public async Task ImportCsvAsync_Test()
        {
            ...
            var service = new ShippingCodesIOManager(DataBaseFactory);
            IList<ShippingCodesDataDto> data;
        ...
        public async Task ExportAsync_Test()
        {
            var fileName = "c:\\temp\\Dto_2.csv";
            var service = new ShippingCodesIOManager(DataBaseFactory);
            IList<ShippingCodesDataDto> dtos = new List<ShippingCodesDataDto>();
            var ShippingCodesService = new ShippingCodesService(DataBaseFactory);
            if (ShippingCodesService.List("9027ebbd-a022-434e-965d-adb20cc27dac"))
                dtos.Add(ShippingCodesService.ToDto());
            if (ShippingCodesService.List("117227d4-43cc-476c-9257-29695d08fdd1"))
                dtos.Add(ShippingCodesService.ToDto());
            if (ShippingCodesService.List("22da3dbb-6d02-4852-a2b8-04c380b36dd6"))
                dtos.Add(ShippingCodesService.ToDto());
