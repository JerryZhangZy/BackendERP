...
namespace DigitBridge.CommerceCentral.ERPMdl.Tests.Integration
{
    ...
    /// </summary>
    public partial class PaidbyMapIOManagerTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        ...
        public PaidbyMapIOManagerTests(TestFixture<StartupTest> fixture)
        {
            Fixture = fixture;
        ...
        public async Task ImportCsvAsync_Test()
        {
            ...
            var service = new PaidbyMapIOManager(DataBaseFactory);
        ...
        public async Task ExportAsync_Test()
        {
            var fileName = "c:\\temp\\Dto_2.csv";
            var service = new PaidbyMapIOManager(DataBaseFactory);
            IList<PaidbyMapDataDto> dtos = new List<PaidbyMapDataDto>();
            var PaidbyMapService = new PaidbyMapService(DataBaseFactory);
            if (PaidbyMapService.List("9027ebbd-a022-434e-965d-adb20cc27dac"))
                dtos.Add(PaidbyMapService.ToDto());
            if (PaidbyMapService.List("117227d4-43cc-476c-9257-29695d08fdd1"))
                dtos.Add(PaidbyMapService.ToDto());
            if (PaidbyMapService.List("22da3dbb-6d02-4852-a2b8-04c380b36dd6"))
                dtos.Add(PaidbyMapService.ToDto());
