...
{
    public partial class PoTransactionServiceTests
    {
		...
		public void AddDto_Test()
		{
            ...
            var id = dto.PoTransaction.TransUuid;
...
");
            ...
            var data = GetFakerData();
            var dto = mapper.WriteDto(data, null);
            dto.PoTransaction.RowNum = rowNum;
            dto.PoTransaction.TransUuid = id;
...
");
            ...
            var payload = new PoTransactionPayload();
            payload.PoTransaction = dto;
            payload.MasterAccountNum = srv.Data.PoTransaction.MasterAccountNum;
            payload.ProfileNum = srv.Data.PoTransaction.ProfileNum;
            payload.DatabaseNum = srv.Data.PoTransaction.DatabaseNum;
