...
{
    /// <summary>
    /// Represents a Tester for VendorService.
    /// NOTE: This class is generated from a T4 template - you should not modify it manually.
    /// </summary>
    public partial class VendorServiceTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        protected VendorData GetFakerData()
        {
            return VendorDataTests.GetFakerData();
        }

        protected List<VendorData> GetFakerData(int count)
        {
            return VendorDataTests.GetFakerData(count);
        }
        ...
        public VendorServiceTests(TestFixture<StartupTest> fixture) 
        {
            Fixture = fixture;
		...
		public void SaveData_Test()
		{
            ...
            var srvGet = new VendorService(DataBaseFactory);
            srvGet.Edit();
...
");
            ...
            srv.Edit();
            srv.GetDataById(id);
            var rowNum = srv.Data.Vendor.RowNum;
            ...
            var srvGetById = new VendorService(DataBaseFactory);
            srvGetById.List();
...
");
            ...
            var result = DataBaseFactory.ExistUniqueId<Vendor>(srv.Data.UniqueId);
