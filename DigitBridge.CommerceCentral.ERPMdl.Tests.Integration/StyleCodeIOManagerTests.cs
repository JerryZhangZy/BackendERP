...
namespace DigitBridge.CommerceCentral.ERPMdl.Tests.Integration
{
    ...
    /// </summary>
    public partial class StyleCodeIOManagerTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        ...
        public StyleCodeIOManagerTests(TestFixture<StartupTest> fixture)
        {
            Fixture = fixture;
        ...
        public async Task ImportCsvAsync_Test()
        {
            ...
            var service = new StyleCodeIOManager(DataBaseFactory);
            IList<StyleCodeDataDto> data;
        ...
        public async Task ExportAsync_Test()
        {
            var fileName = "c:\\temp\\Dto_2.csv";
            var service = new StyleCodeIOManager(DataBaseFactory);
            IList<StyleCodeDataDto> dtos = new List<StyleCodeDataDto>();
            var StyleCodeService = new StyleCodeService(DataBaseFactory);
            if (StyleCodeService.List("9027ebbd-a022-434e-965d-adb20cc27dac"))
                dtos.Add(StyleCodeService.ToDto());
            if (StyleCodeService.List("117227d4-43cc-476c-9257-29695d08fdd1"))
                dtos.Add(StyleCodeService.ToDto());
            if (StyleCodeService.List("22da3dbb-6d02-4852-a2b8-04c380b36dd6"))
                dtos.Add(StyleCodeService.ToDto());
