...
namespace DigitBridge.CommerceCentral.ERPMdl.Tests.Integration
{
    ...
    public partial class InvoiceIOManagerTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        ...
        public async Task ExportAsync_Test()
        {
            ...
            var InvoiceService = new InvoiceService(DataBaseFactory);
            if (InvoiceService.List("0062894e-edd5-4841-98a2-72b801d428bf"))
                dtos.Add(InvoiceService.ToDto());
            if (InvoiceService.List("7feb1dd5-ea37-4655-a247-fd998d4ce04f"))
                dtos.Add(InvoiceService.ToDto());
            if (InvoiceService.List("0450075f-3abc-404d-a57b-58d3e177368a"))
                dtos.Add(InvoiceService.ToDto());
        ...
        public async Task ExportAllColumnsAsync_Test()
        {
            ...
            IList<InvoiceDataDto> dtos = new List<InvoiceDataDto>();
            var InvoiceService = new InvoiceService(DataBaseFactory);
            if (InvoiceService.List("9027ebbd-a022-434e-965d-adb20cc27dac"))
                dtos.Add(InvoiceService.ToDto());
            if (InvoiceService.List("117227d4-43cc-476c-9257-29695d08fdd1"))
                dtos.Add(InvoiceService.ToDto());
            if (InvoiceService.List("22da3dbb-6d02-4852-a2b8-04c380b36dd6"))
                dtos.Add(InvoiceService.ToDto());
