...
{
    /// <summary>
    /// Represents a Tester for InventoryUpdateService.
    /// NOTE: This class is generated from a T4 template - you should not modify it manually.
    /// </summary>
    public partial class InventoryUpdateServiceTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        protected InventoryUpdateData GetFakerData()
        {
            return InventoryUpdateDataTests.GetFakerData();
        }

        protected List<InventoryUpdateData> GetFakerData(int count)
        {
            return InventoryUpdateDataTests.GetFakerData(count);
        }
        ...
        public InventoryUpdateServiceTests(TestFixture<StartupTest> fixture) 
        {
            Fixture = fixture;
...
");
            ...
            var srvGetById = new InventoryUpdateService(DataBaseFactory);
            srvGetById.List();
...
");
            ...
            var result = DataBaseFactory.ExistUniqueId<InventoryUpdateHeader>(srv.Data.UniqueId);
