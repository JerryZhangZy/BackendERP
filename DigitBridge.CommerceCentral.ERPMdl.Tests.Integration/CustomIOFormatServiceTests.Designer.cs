...
{
    /// <summary>
    /// Represents a Tester for CustomIOFormatService.
    /// NOTE: This class is generated from a T4 template - you should not modify it manually.
    /// </summary>
    public partial class CustomIOFormatServiceTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        protected CustomIOFormatData GetFakerData()
        {
            return CustomIOFormatDataTests.GetFakerData();
        }

        protected List<CustomIOFormatData> GetFakerData(int count)
        {
            return CustomIOFormatDataTests.GetFakerData(count);
        }
        ...
        public CustomIOFormatServiceTests(TestFixture<StartupTest> fixture) 
        {
            Fixture = fixture;
...
");
            ...
            var srvGetById = new CustomIOFormatService(DataBaseFactory);
            srvGetById.List();
...
");
            ...
            var result = DataBaseFactory.ExistUniqueId<CustomIOFormat>(srv.Data.UniqueId);
