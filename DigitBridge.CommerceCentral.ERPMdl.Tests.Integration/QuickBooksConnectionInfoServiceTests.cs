...
{
    public partial class QuickBooksConnectionInfoServiceTests
    {
		...
		{
            var srv = new QuickBooksConnectionInfoService(DataBaseFactory);
            srv.Add();
            ...
            var id = dto.QuickBooksConnectionInfo.ConnectionUuid;

            var srvGet = new QuickBooksConnectionInfoService(DataBaseFactory);
            //srvGet.Edit();
...
");
            ...
            var srv = new QuickBooksConnectionInfoService(DataBaseFactory);
            srv.Edit(id);
            var rowNum = srv.Data.QuickBooksConnectionInfo.RowNum;

            var mapper = srv.DtoMapper;
            var data = GetFakerData();
            var dto = mapper.WriteDto(data, null);
            dto.QuickBooksConnectionInfo.RowNum = rowNum;
            dto.QuickBooksConnectionInfo.ConnectionUuid = id;
...
");
		...
		public void AddPayload_Test()
		{
            ...
            payload.QuickBooksConnectionInfo = dto;
...
");
            ...
            var payload = new QuickBooksConnectionInfoPayload();
            payload.QuickBooksConnectionInfo = dto;
            payload.MasterAccountNum = srv.Data.QuickBooksConnectionInfo.MasterAccountNum;
            payload.ProfileNum = srv.Data.QuickBooksConnectionInfo.ProfileNum;
            payload.DatabaseNum = srv.Data.QuickBooksConnectionInfo.DatabaseNum;
