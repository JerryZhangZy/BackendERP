...
namespace DigitBridge.CommerceCentral.ERPMdl.Tests.Integration
{
    ...
    /// </summary>
    public partial class InvoiceReturnIOManagerTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        ...
        public InvoiceReturnIOManagerTests(TestFixture<StartupTest> fixture)
        {
            Fixture = fixture;
        ...
        public async Task ImportCsvAsync_Test()
        {
            ...
            var service = new InvoiceReturnIOManager(DataBaseFactory);
