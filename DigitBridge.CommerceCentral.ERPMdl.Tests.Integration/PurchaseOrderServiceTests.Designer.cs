...
namespace DigitBridge.CommerceCentral.ERPMdl.Tests.Integration
{
    ...
    /// </summary>
    public partial class PurchaseOrderServiceTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        ...
        public PurchaseOrderServiceTests(TestFixture<StartupTest> fixture) 
        {
            Fixture = fixture;
...
");
            ...
            var srvGetById = new PurchaseOrderService(DataBaseFactory);
            srvGetById.List();
...
");
            ...
            var result = DataBaseFactory.ExistUniqueId<PoHeader>(srv.Data.UniqueId);
