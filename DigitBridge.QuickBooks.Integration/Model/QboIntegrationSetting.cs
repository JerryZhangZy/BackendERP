...
namespace DigitBridge.QuickBooks.Integration
{
    public class QboIntegrationSetting
    {
        ...
        public string QboSalesTaxItemId { get; set; }
        /// <summary>
