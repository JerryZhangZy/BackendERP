...
{
    /// <summary>
    /// Represents a default QuickBooksConnectionInfoService Calculator class.
    /// </summary>
    public partial class QuickBooksConnectionInfoServiceCalculatorDefault : ICalculator<QuickBooksConnectionInfoData>
    {
        protected IDataBaseFactory dbFactory { get; set; }

        public QuickBooksConnectionInfoServiceCalculatorDefault(IMessage serviceMessage, IDataBaseFactory dbFactory)
        {
            this.ServiceMessage = serviceMessage;
            this.dbFactory = dbFactory;
        }

        public virtual void PrepareData(QuickBooksConnectionInfoData  data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
        ...
        public virtual bool SetDefault(QuickBooksConnectionInfoData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
        ...
        public virtual bool SetDefaultSummary(QuickBooksConnectionInfoData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (data is null)
                return false;
            ...
            var sum = data.QuickBooksConnectionInfo;
        ...
        public virtual bool SetDefaultDetail(QuickBooksConnectionInfoData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (data is null)
                return false;
        ...
        /* This is generated sample code
        protected virtual bool SetDefault(InvoiceItems item, QuickBooksConnectionInfoData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (item is null || item.IsEmpty)
                return false;
        ...
        */
        ...
        public virtual bool Calculate(QuickBooksConnectionInfoData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            PrepareData(data);
        ...
        public virtual bool CalculateSummary(QuickBooksConnectionInfoData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (data is null)
                return false;
        ...
        public virtual bool CalculateDetail(QuickBooksConnectionInfoData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (data is null)
                return false;
        ...
        //TODO: add set default for detail line logic
        /* This is generated sample code
        protected virtual bool CalculateDetail(InvoiceItems item, QuickBooksConnectionInfoData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (item is null || item.IsEmpty)
                return false;
