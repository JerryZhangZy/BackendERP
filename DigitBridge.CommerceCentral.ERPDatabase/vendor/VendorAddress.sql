...
CREATE UNIQUE NONCLUSTERED INDEX [UK_VendorAddress_VendorUuid_AddressCode] ON [dbo].[VendorAddress]
(
	[VendorUuid] ASC,
	[AddressCode] ASC
) ON [PRIMARY]
...
CREATE NONCLUSTERED INDEX [UK_VendorAddress_VendorUuid] ON [dbo].[VendorAddress]
(
	[VendorUuid] ASC
) ON [PRIMARY]
GO
