...
(
    ...
    [DocNumber] VARCHAR(100) NOT NULL DEFAULT '', --QuickBooks DocNumber <br> Title: DocNumber, Display: true, Editable: false	
    [DocStatus] INT NULL DEFAULT 0, --Quickbook Return status. <br> Title: Status, Display: true, Editable: false
    ...
    [LogStatus] int not null default 0, ----log status. <br> Title: Status, Display: true, Editable: false
    [ErrorMessage] NText NOT NULL DEFAULT '', --log error messages.<br> Title:ErrorMessage,Display:true,Editable:false
    [RequestInfo] NVARCHAR(2000) NOT NULL DEFAULT '',--log request info , qbo entity.<br> Title:RequestInfo,Display:true,Editable:false
