...
(
	...
	[WarehouseCode] VARCHAR(50) NOT NULL DEFAULT '', --(Readonly) Readable warehouse code, load from inventory data. <br> Title: Warehouse Code, Display: true, Editable: true
	...
	[PriceRule] VARCHAR(50) NOT NULL DEFAULT '', --Item Order price rule. <br> Title: Price Type, Display: true, Editable: true
	[Price] DECIMAL(24, 6) NOT NULL DEFAULT 0, --Item Order price. <br> Title: Unit Price, Display: true, Editable: true
	...
	[TaxRate] DECIMAL(24, 6) NOT NULL DEFAULT 0, --Default Tax rate for Order items. <br> Display: false, Editable: false
	...
	[ShippingAmount] DECIMAL(24, 6) NOT NULL DEFAULT 0, --Total shipping fee for all items. <br> Display: false, Editable: false
	...
	[ItemTotalAmount] DECIMAL(24, 6) NOT NULL DEFAULT 0, --Item total amount. <br> Display: false, Editable: false
	[ShipAmount] DECIMAL(24, 6) NOT NULL DEFAULT 0, --Item total amount. <br> Display: false, Editable: false
	[CancelledAmount] DECIMAL(24, 6) NOT NULL DEFAULT 0, --Item total amount. <br> Display: false, Editable: false
	[OpenAmount] DECIMAL(24, 6) NOT NULL DEFAULT 0, --Item total amount. <br> Display: false, Editable: false

	[Stockable] TINYINT NOT NULL DEFAULT 1,--Order item will update inventory instock qty. <br> Title: Stockable, Display: true, Editable: true
	[IsAr] TINYINT NOT NULL DEFAULT 1,--Order item will add to Order total amount. <br> Title: A/R, Display: true, Editable: true
	[Taxable] TINYINT NOT NULL DEFAULT 0,--Order item will apply tax. <br> Title: Taxable, Display: true, Editable: true
	[Costable] TINYINT NOT NULL DEFAULT 1,--Order item will calculate total cost. <br> Title: Apply Cost, Display: true, Editable: true
	[IsProfit] TINYINT NOT NULL DEFAULT 1,--Invoice item will calculate profit. <br> Title: Apply Profit, Display: true, Editable: true
