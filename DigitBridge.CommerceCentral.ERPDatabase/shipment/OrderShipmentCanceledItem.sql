CREATE TABLE [dbo].[OrderShipmentCanceledItem](
	...
	[CanceledQty] [decimal](24, 6) NOT NULL DEFAULT 0, --Canceled Qty. <br> Title: Canceled Qty, Display: true, Editable: true
	[CancelCode] [varchar](50) NOT NULL DEFAULT '', --Cancel code. <br> Title: Cancel Code, Display: true, Editable: true
	[CancelOtherReason] [nvarchar](200) NOT NULL DEFAULT '', --Cancel Reason. <br> Title: Cancel Reason, Display: true, Editable: true
