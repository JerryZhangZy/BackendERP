...
(
    ...
    [PoUuid] VARCHAR(50) NOT NULL, --Global Unique Guid for P/O, '0' for multiple P/O
...
CREATE UNIQUE NONCLUSTERED INDEX [UI_PoTransaction_TransUuid] ON [dbo].[PoTransaction]
(
	[TransUuid] ASC
) ON [PRIMARY]
GO
...
CREATE NONCLUSTERED INDEX [IX_PoTransaction_PoUuid] ON [dbo].[PoTransaction]
(
	[PoUuid] ASC
) ON [PRIMARY]
GO
