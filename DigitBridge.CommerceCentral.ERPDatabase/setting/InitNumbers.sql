...
(
	...
	[Number] BIGINT NOT NULL DEFAULT 0, --Init number, real number will be more than init number and not exist number  
	...
	[EndNumber] BIGINT NOT NULL DEFAULT 0, --End number, real number will be less than end number and not exist number  
