...
namespace DigitBridge.CommerceCentral.ERPMdl
{
    public class CustomerSummaryQuery : QueryObject<CustomerSummaryQuery>
    {
        ...
        protected QueryFilter<DateTime> _DateFrom = new QueryFilter<DateTime>("DateFrom", "InvoiceDate", PREFIX, FilterBy.ge, SqlQuery._SqlMinDateTime, isDate: true);
        public QueryFilter<DateTime> DateFrom => _DateFrom;

        protected QueryFilter<DateTime> _DateTo = new QueryFilter<DateTime>("DateTo", "InvoiceDate", PREFIX, FilterBy.le, SqlQuery._AppMaxDateTime, isDate: true);
