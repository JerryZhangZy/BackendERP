...
{
    /// <summary>
    /// Represents a PoTransactionIOCsv Class.
    /// NOTE: This class is generated from a T4 template Once - you you wanr re-generate it, you need delete cs file and generate again
    /// </summary>
    [Serializable()]
    public partial class PoReceiveIOCsv : CsvHelper<PoTransactionDataDto>
    {
        public PoReceiveIOCsv(PoReceiveIOFormat format): base(format)
        {
        }
        ...
        public override void GetMapper()
        {
            ...
            {
				new CsvFormatMapper<PoTransactionDto>(Format),
				new CsvFormatMapper<PoTransactionItemsDto>(Format),
            };
        }
        ...
        /// </summary>
        public override async Task ReadEntitiesAsync(CsvReader csv, IList<PoTransactionDataDto> data)
        {
            var hasReadSummary = false;
            var headerFound = false;
            var dto = new PoTransactionDataDto().NewData();
                ...
                else
                {
                    ...
                    if (keyValues != null)
                    {
                        ...
                        if (!keyValues.IsEqualTo(currentKeyValues))
                        {
                            ...
                            {
                                data.Add(dto);
                                dto = new PoTransactionDataDto().NewData();
                                hasReadSummary = false;
                            }
                        }
        ...
        /// </summary>
        protected virtual async Task<bool> ReadSummaryRecordAsync(CsvReader csv, PoTransactionDataDto dto)
        {
            try
            {
        ...
        /// </summary>
        protected virtual async Task<bool> ReadDetailRecordAsync(CsvReader csv, PoTransactionDataDto dto)
        {
            try
            {
				var ln = csv.GetRecord<PoTransactionItemsDto>();
				if (ln == null || !ln.HasSKU)
					return false;
				dto.PoTransactionItems.Add(ln);
                return true;
            }
            catch (Exception e)
            {
        ...
        /// </summary>
        public override async Task<byte[]> ExportAsync(IEnumerable<PoTransactionDataDto> datas)
        {
        ...
        /// </summary>
        protected virtual IList<string> GetHeader(IEnumerable<PoTransactionDataDto> datas)
        {
            if (Format == null || datas == null || !datas.Any()) return null;
        ...
        /// </summary>
        protected virtual IList<IList<string>> GetDataLines(PoTransactionDataDto data)
        {
			...
			// build PoTransaction data
			var (header1, values1) = Format.GetHeaderAndData<PoTransactionDto>(data.PoTransaction);
			if (values1 != null) lnSummary.AddRange(values1);
			
			// build PoTransactionItems data
			foreach (var item in data.PoTransactionItems)
			{
				if (item == null) continue;
				var (headerLine, valuesLine) = Format.GetHeaderAndData<PoTransactionItemsDto>(item);
