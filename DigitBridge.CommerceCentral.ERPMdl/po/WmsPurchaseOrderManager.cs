...
namespace DigitBridge.CommerceCentral.ERPMdl
{
    ...
    /// </summary>
    public class WmsPurchaseOrderManager :  IPurchaseOrderManager , IMessage
    {

        public WmsPurchaseOrderManager() : base() {}

        public WmsPurchaseOrderManager(IDataBaseFactory dbFactory)
        {
