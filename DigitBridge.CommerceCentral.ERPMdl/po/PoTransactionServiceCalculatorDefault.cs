...
namespace DigitBridge.CommerceCentral.ERPMdl
{
    ...
    /// </summary>
    public partial class PoTransactionServiceCalculatorDefault : ICalculator<PoTransactionData>
    {
        protected IDataBaseFactory dbFactory { get; set; }

        public PoTransactionServiceCalculatorDefault(IMessage serviceMessage, IDataBaseFactory dbFactory)
        {
        ...
        /* This is generated sample code
        protected virtual bool SetDefault(InvoiceItems item, PoTransactionData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (item is null || item.IsEmpty)
                return false;
        ...
        */
        ...
        //TODO: add set default for detail line logic
        /* This is generated sample code
        protected virtual bool CalculateDetail(InvoiceItems item, PoTransactionData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (item is null || item.IsEmpty)
                return false;
