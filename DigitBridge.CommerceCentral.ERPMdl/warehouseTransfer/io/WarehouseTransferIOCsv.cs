...
{
    /// <summary>
    /// Represents a WarehouseTransferIOCsv Class.
    /// NOTE: This class is generated from a T4 template Once - you you wanr re-generate it, you need delete cs file and generate again
    /// </summary>
    [Serializable()]
    public partial class WarehouseTransferIOCsv : CsvHelper<WarehouseTransferDataDto>
    {
        public WarehouseTransferIOCsv(WarehouseTransferIOFormat format): base(format)
        {
        }
        ...
        public override void GetMapper()
        {
            ...
            {
				new CsvFormatMapper<WarehouseTransferHeaderDto>(Format),
				new CsvFormatMapper<WarehouseTransferItemsDto>(Format),
            };
        }
        ...
        /// </summary>
        public override async Task ReadEntitiesAsync(CsvReader csv, IList<WarehouseTransferDataDto> data)
        {
            var hasReadSummary = false;
            var headerFound = false;
            var dto = new WarehouseTransferDataDto().NewData();
                ...
                else
                {
                    ...
                    if (keyValues != null)
                    {
                        ...
                        if (!keyValues.IsEqualTo(currentKeyValues))
                        {
                            ...
                            {
                                data.Add(dto);
                                dto = new WarehouseTransferDataDto().NewData();
                                hasReadSummary = false;
                            }
                        }
        ...
        /// </summary>
        protected virtual async Task<bool> ReadSummaryRecordAsync(CsvReader csv, WarehouseTransferDataDto dto)
        {
            try
            {
        ...
        /// </summary>
        protected virtual async Task<bool> ReadDetailRecordAsync(CsvReader csv, WarehouseTransferDataDto dto)
        {
            try
            {
				var ln = csv.GetRecord<WarehouseTransferItemsDto>();
				if (ln == null || !ln.HasSKU)
					return false;
				dto.WarehouseTransferItems.Add(ln);
                return true;
            }
            catch (Exception e)
            {
        ...
        /// </summary>
        public override async Task<byte[]> ExportAsync(IEnumerable<WarehouseTransferDataDto> datas)
        {
        ...
        /// </summary>
        protected virtual IList<string> GetHeader(IEnumerable<WarehouseTransferDataDto> datas)
        {
            if (Format == null || datas == null || !datas.Any()) return null;
        ...
        /// </summary>
        protected virtual IList<IList<string>> GetDataLines(WarehouseTransferDataDto data)
        {
			...
			// build WarehouseTransferHeader data
			var (header1, values1) = Format.GetHeaderAndData<WarehouseTransferHeaderDto>(data.WarehouseTransferHeader);
			if (values1 != null) lnSummary.AddRange(values1);
			
			// build WarehouseTransferItems data
			foreach (var item in data.WarehouseTransferItems)
			{
				if (item == null) continue;
				var (headerLine, valuesLine) = Format.GetHeaderAndData<WarehouseTransferItemsDto>(item);
