...
{
    /// <summary>
    /// Represents a ChannelHelper SQL Helper Static Class.
...
/*
            var sql = $@"
SELECT COUNT(1) FROM Setting_Channel tbl
...
";
        ...
        {
            var sql = $@"
SELECT MasterAccountNum FROM Setting_Channel tbl
WHERE MasterAccountNum = @masterAccountNum
AND ProfileNum = @profileNum";
