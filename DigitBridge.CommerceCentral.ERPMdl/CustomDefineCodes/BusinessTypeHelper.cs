...
{
    /// <summary>
    /// Represents a BusinessTypeHelper SQL Helper Static Class.
...
/*
            var sql = $@"
SELECT COUNT(1) FROM BusinessType tbl
...
";
        ...
        {
            var sql = $@"
SELECT RowNum FROM BusinessType tbl
WHERE MasterAccountNum = @masterAccountNum
AND ProfileNum = @profileNum";
