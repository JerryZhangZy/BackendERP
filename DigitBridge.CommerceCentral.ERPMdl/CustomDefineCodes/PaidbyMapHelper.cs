...
{
    /// <summary>
    /// Represents a PaidbyMapHelper SQL Helper Static Class.
    /// NOTE: This class is generated from a T4 template Once - you you wanr re-generate it, you need delete cs file and generate again
    /// </summary>
    public static class PaidbyMapHelper
    {
        public static async Task<List<PaidbyKey>> GetPaidbyMapKeys(int masterAccountNum, int profileNum)
        {
            var sql = $@"
SELECT MasterAccountNum, ProfileNum, ChannelNum, ChannelAccountNum, ChannelPaidBy FROM PaidbyMap tbl
WHERE MasterAccountNum = @masterAccountNum
AND ProfileNum = @profileNum
";
            var result = await SqlQuery.ExecuteAsync(sql, 
                (int mstacc, int pfn, int cn, int can, string cpb) => new PaidbyKey 
                { 
                    MasterAccountNum = mstacc,
                    ProfileNum = pfn,
                    ChannelNum = cn,
                    ChannelAccountNum = can,
                    ChannelPaidby = cpb
                },
...
/*
            var sql = $@"
SELECT COUNT(1) FROM PaidbyMap tbl
WHERE MasterAccountNum = @masterAccountNum
AND ProfileNum = @profileNum
...
";
        ...
        {
            var sql = $@"
SELECT RowNum FROM PaidbyMap tbl
WHERE MasterAccountNum = @masterAccountNum
AND ProfileNum = @profileNum";
