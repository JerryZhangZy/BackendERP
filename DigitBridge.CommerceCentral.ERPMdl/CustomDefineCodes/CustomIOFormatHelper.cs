...
{
    /// <summary>
    /// Represents a CustomIOFormatHelper SQL Helper Static Class.
...
/*
            var sql = $@"
SELECT COUNT(1) FROM CustomIOFormat tbl
...
";
        ...
        {
            var sql = $@"
SELECT RowNum FROM CustomIOFormat tbl
WHERE MasterAccountNum = @masterAccountNum
AND ProfileNum = @profileNum";
