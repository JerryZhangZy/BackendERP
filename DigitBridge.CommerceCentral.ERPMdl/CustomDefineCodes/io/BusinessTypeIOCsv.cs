...
{
    /// <summary>
    /// Represents a BusinessTypeIOCsv Class.
    /// NOTE: This class is generated from a T4 template Once - you you wanr re-generate it, you need delete cs file and generate again
    /// </summary>
    [Serializable()]
    public partial class BusinessTypeIOCsv : CsvHelper<BusinessTypeDataDto>
    {
        public BusinessTypeIOCsv(BusinessTypeIOFormat format): base(format)
        {
        }
        public BusinessTypeIOCsv(BusinessTypeIOFormat format, IMessage serviceMessage): base(format, serviceMessage)
        {
        }
        ...
        public override void GetMapper()
        {
            ...
            {
				new CsvFormatMapper<BusinessTypeDto>(Format),
            };
        }
        ...
        /// </summary>
        public override async Task ReadEntitiesAsync(CsvReader csv, IList<BusinessTypeDataDto> data)
        {
            var hasReadSummary = false;
            var headerFound = false;
            var dto = new BusinessTypeDataDto().NewData();
                ...
                else
                {
                    ...
                    if (keyValues != null)
                    {
                        ...
                        if (!keyValues.IsEqualTo(currentKeyValues))
                        {
                            ...
                            {
                                data.Add(dto);
                                dto = new BusinessTypeDataDto().NewData();
                                hasReadSummary = false;
                            }
                        }
        ...
        /// </summary>
        protected virtual async Task<bool> ReadSummaryRecordAsync(CsvReader csv, BusinessTypeDataDto dto)
        {
            try
            {
				dto.BusinessType = csv.GetRecord<BusinessTypeDto>();
                return true;
            }
            catch (Exception e)
            {
        ...
        /// </summary>
        protected virtual async Task<bool> ReadDetailRecordAsync(CsvReader csv, BusinessTypeDataDto dto)
        {
            try
            {
                return true;
        ...
        /// </summary>
        public override async Task<byte[]> ExportAsync(IEnumerable<BusinessTypeDataDto> datas)
        {
        ...
        /// </summary>
        protected virtual IList<string> GetHeader(IEnumerable<BusinessTypeDataDto> datas)
        {
            if (Format == null || datas == null || !datas.Any()) return null;
			...
			// build BusinessType header
			var (header1, values1) = Format.GetHeaderAndData<BusinessTypeDto>(dataList[0].BusinessType);
        ...
        /// </summary>
        protected virtual IList<IList<string>> GetDataLines(BusinessTypeDataDto data)
        {
			...
			// build BusinessType data
			var (header1, values1) = Format.GetHeaderAndData<BusinessTypeDto>(data.BusinessType);
