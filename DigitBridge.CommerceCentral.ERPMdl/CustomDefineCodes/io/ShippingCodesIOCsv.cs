...
{
    /// <summary>
    /// Represents a ShippingCodesIOCsv Class.
    /// NOTE: This class is generated from a T4 template Once - you you wanr re-generate it, you need delete cs file and generate again
    /// </summary>
    [Serializable()]
    public partial class ShippingCodesIOCsv : CsvHelper<ShippingCodesDataDto>
    {
        public ShippingCodesIOCsv(ShippingCodesIOFormat format): base(format)
        {
        }
        public ShippingCodesIOCsv(ShippingCodesIOFormat format, IMessage serviceMessage): base(format, serviceMessage)
        {
        }
        ...
        public override void GetMapper()
        {
            ...
            {
				new CsvFormatMapper<ShippingCodesDto>(Format),
            };
        }
        ...
        /// </summary>
        public override async Task ReadEntitiesAsync(CsvReader csv, IList<ShippingCodesDataDto> data)
        {
            var hasReadSummary = false;
            var headerFound = false;
            var dto = new ShippingCodesDataDto().NewData();
                ...
                else
                {
                    ...
                    if (keyValues != null)
                    {
                        ...
                        if (!keyValues.IsEqualTo(currentKeyValues))
                        {
                            ...
                            {
                                data.Add(dto);
                                dto = new ShippingCodesDataDto().NewData();
                                hasReadSummary = false;
                            }
                        }
        ...
        /// </summary>
        protected virtual async Task<bool> ReadSummaryRecordAsync(CsvReader csv, ShippingCodesDataDto dto)
        {
            try
            {
        ...
        /// </summary>
        protected virtual async Task<bool> ReadDetailRecordAsync(CsvReader csv, ShippingCodesDataDto dto)
        {
            try
            {
                return true;
        ...
        /// </summary>
        public override async Task<byte[]> ExportAsync(IEnumerable<ShippingCodesDataDto> datas)
        {
        ...
        /// </summary>
        protected virtual IList<string> GetHeader(IEnumerable<ShippingCodesDataDto> datas)
        {
            if (Format == null || datas == null || !datas.Any()) return null;
			...
			// build ShippingCodes header
			var (header1, values1) = Format.GetHeaderAndData<ShippingCodesDto>(dataList[0].ShippingCodes);
        ...
        /// </summary>
        protected virtual IList<IList<string>> GetDataLines(ShippingCodesDataDto data)
        {
			...
			// build ShippingCodes data
			var (header1, values1) = Format.GetHeaderAndData<ShippingCodesDto>(data.ShippingCodes);
