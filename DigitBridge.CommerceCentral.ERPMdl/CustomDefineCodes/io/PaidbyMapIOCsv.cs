...
{
    /// <summary>
    /// Represents a PaidbyMapIOCsv Class.
    /// NOTE: This class is generated from a T4 template Once - you you wanr re-generate it, you need delete cs file and generate again
    /// </summary>
    [Serializable()]
    public partial class PaidbyMapIOCsv : CsvHelper<PaidbyMapDataDto>
    {
        public PaidbyMapIOCsv(PaidbyMapIOFormat format): base(format)
        {
        }
        public PaidbyMapIOCsv(PaidbyMapIOFormat format, IMessage serviceMessage): base(format, serviceMessage)
        {
        }
        ...
        public override void GetMapper()
        {
            ...
            {
				new CsvFormatMapper<PaidbyMapDto>(Format),
            };
        }
        ...
        /// </summary>
        public override async Task ReadEntitiesAsync(CsvReader csv, IList<PaidbyMapDataDto> data)
        {
            var hasReadSummary = false;
            var headerFound = false;
            var dto = new PaidbyMapDataDto().NewData();
                ...
                else
                {
                    ...
                    if (keyValues != null)
                    {
                        ...
                        if (!keyValues.IsEqualTo(currentKeyValues))
                        {
                            ...
                            {
                                data.Add(dto);
                                dto = new PaidbyMapDataDto().NewData();
                                hasReadSummary = false;
                            }
                        }
        ...
        /// </summary>
        protected virtual async Task<bool> ReadSummaryRecordAsync(CsvReader csv, PaidbyMapDataDto dto)
        {
            try
            {
				dto.PaidbyMap = csv.GetRecord<PaidbyMapDto>();
                return true;
            }
            catch (Exception e)
            {
        ...
        /// </summary>
        protected virtual async Task<bool> ReadDetailRecordAsync(CsvReader csv, PaidbyMapDataDto dto)
        {
            try
            {
                return true;
        ...
        /// </summary>
        public override async Task<byte[]> ExportAsync(IEnumerable<PaidbyMapDataDto> datas)
        {
        ...
        /// </summary>
        protected virtual IList<string> GetHeader(IEnumerable<PaidbyMapDataDto> datas)
        {
            if (Format == null || datas == null || !datas.Any()) return null;
			...
			// build PaidbyMap header
			var (header1, values1) = Format.GetHeaderAndData<PaidbyMapDto>(dataList[0].PaidbyMap);
        ...
        /// </summary>
        protected virtual IList<IList<string>> GetDataLines(PaidbyMapDataDto data)
        {
			...
			// build PaidbyMap data
			var (header1, values1) = Format.GetHeaderAndData<PaidbyMapDto>(data.PaidbyMap);
