...
{
    /// <summary>
    /// Represents a default PaidbyMapService Calculator class.
    /// </summary>
    public partial class PaidbyMapServiceCalculatorDefault : ICalculator<PaidbyMapData>
    {
        protected IDataBaseFactory dbFactory { get; set; }

        public PaidbyMapServiceCalculatorDefault(IMessage serviceMessage, IDataBaseFactory dbFactory)
        {
            this.ServiceMessage = serviceMessage;
            this.dbFactory = dbFactory;
        }

        public virtual void PrepareData(PaidbyMapData  data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
        ...
        public virtual bool SetDefault(PaidbyMapData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
        ...
        public virtual bool SetDefaultSummary(PaidbyMapData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (data is null)
                return false;
        ...
        public virtual bool SetDefaultDetail(PaidbyMapData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (data is null)
                return false;
        ...
        /* This is generated sample code
        protected virtual bool SetDefault(InvoiceItems item, PaidbyMapData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (item is null || item.IsEmpty)
                return false;
        ...
        */
        ...
        public virtual bool Calculate(PaidbyMapData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            PrepareData(data);
        ...
        public virtual bool CalculateSummary(PaidbyMapData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (data is null)
                return false;
        ...
        public virtual bool CalculateDetail(PaidbyMapData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (data is null)
                return false;
        ...
        //TODO: add set default for detail line logic
        /* This is generated sample code
        protected virtual bool CalculateDetail(InvoiceItems item, PaidbyMapData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (item is null || item.IsEmpty)
                return false;
