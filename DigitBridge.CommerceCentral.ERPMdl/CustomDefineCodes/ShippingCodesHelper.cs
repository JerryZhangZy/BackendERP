...
{
    /// <summary>
    /// Represents a ShippingCodesHelper SQL Helper Static Class.
...
/*
            var sql = $@"
SELECT COUNT(1) FROM ShippingCodes tbl
...
";
        ...
        {
            var sql = $@"
SELECT RowNum FROM ShippingCodes tbl
WHERE MasterAccountNum = @masterAccountNum
AND ProfileNum = @profileNum";
