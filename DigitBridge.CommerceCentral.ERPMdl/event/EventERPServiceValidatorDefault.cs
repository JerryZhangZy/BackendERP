...
{
    /// <summary>
    /// Represents a default EventERPService Validator class.
    /// </summary>
    public partial class EventERPServiceValidatorDefault : IValidator<EventERPData,EventERPDataDto>, IMessage
    {
        public virtual bool IsValid { get; set; }
        public EventERPServiceValidatorDefault() { }
        public EventERPServiceValidatorDefault(IMessage serviceMessage, IDataBaseFactory dbFactory) 
        { 
        ...
        public virtual bool Validate(EventERPData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            Clear();
        ...
        protected virtual bool ValidateAllMode(EventERPData data)
        {
            var dbFactory = data.dbFactory;
            if (string.IsNullOrEmpty(data.Event_ERP.EventUuid))
            {
                IsValid = false;
                AddError($"Unique Id cannot be empty.");
                return IsValid;
            }
            //if (string.IsNullOrEmpty(data.Event_ERP.CustomerUuid))
            //{
            //    IsValid = false;
        ...
        public virtual async Task<bool> ValidateAsync(EventERPData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            Clear();
        ...
        protected virtual async Task<bool> ValidateAllModeAsync(EventERPData data)
        {
            var dbFactory = data.dbFactory;
            if (string.IsNullOrEmpty(data.Event_ERP.EventUuid))
            {
        ...
        protected virtual async Task<bool> ValidateDeleteAsync(EventERPData data)
        {
            var dbFactory = data.dbFactory;
            if (data.Event_ERP.RowNum == 0)
            {
        ...
        /// <returns></returns>
        public virtual bool Validate(EventERPDataDto dto, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            var isValid = true;
            if (dto is null)
            {
        ...
        /// <param name="processingMode"></param>
        /// <returns></returns>
        public virtual async Task<bool> ValidateAsync(EventERPDataDto dto, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            var isValid = true;
            if (dto is null)
            {
