...
SUM(CASE WHEN COALESCE({Helper.TableAllies}.TransStatus, 0) = 0 THEN 1 ELSE 0 END) as authorizedCount,
SUM(CASE WHEN COALESCE({Helper.TableAllies}.TransStatus, 0) = 1 THEN 1 ELSE 0 END) as receivedCount,
SUM(CASE WHEN COALESCE({Helper.TableAllies}.TransStatus, 0) = 2 THEN 1 ELSE 0 END) as closedCount,
SUM(COALESCE({Helper.TableAllies}.TotalAmount, 0)) AS totalAmount,
SUM(CASE WHEN COALESCE({Helper.TableAllies}.TransStatus, 0) = 0 THEN {Helper.TableAllies}.TotalAmount ELSE 0 END) as authorizedAmount,
SUM(CASE WHEN COALESCE({Helper.TableAllies}.TransStatus, 0) = 1 THEN {Helper.TableAllies}.TotalAmount ELSE 0 END) as receivedAmount,
SUM(CASE WHEN COALESCE({Helper.TableAllies}.TransStatus, 0) = 2 THEN {Helper.TableAllies}.TotalAmount ELSE 0 END) as closedAmount
";
