...
SUM(CASE WHEN COALESCE({Helper.TableAllies}.InvoiceStatus, 0) = 100 THEN 1 ELSE 0 END) as dueCount,
SUM(CASE WHEN COALESCE({Helper.TableAllies}.InvoiceStatus, 0) = 255 THEN 1 ELSE 0 END) as voidCount,
...
SUM(CASE WHEN COALESCE({Helper.TableAllies}.InvoiceStatus, 0) = 100 THEN {Helper.TableAllies}.TotalAmount ELSE 0 END) as dueAmount,
SUM(CASE WHEN COALESCE({Helper.TableAllies}.InvoiceStatus, 0) = 255 THEN {Helper.TableAllies}.TotalAmount ELSE 0 END) as voidAmount
";
