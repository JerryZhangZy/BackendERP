...
{
    /// <summary>
    /// Represents a InvoiceIOFormat Class.
    /// NOTE: This class is generated from a T4 template Once - you you wanr re-generate it, you need delete cs file and generate again
    /// </summary>
    [Serializable()]
    public partial class InvoiceIOFormat : CsvFormat
    {
        public InvoiceIOFormat() : base()
        {
            InitConfig();
			InitInvoiceHeader();
			InitInvoiceHeaderInfo();
			InitInvoiceHeaderAttributes();
			InitInvoiceItems();
        }
        ...
        {
            FormatNum = 1;
            FormatName = "Invoice Deafult Format";
            KeyName = "";
			DefaultKeyName = "InvoiceUuid";
            HasHeaderRecord = true;
        }

    
		protected virtual void InitInvoiceHeader()
		{
			var obj = this.InitParentObject<InvoiceHeaderDto>();
			var idx = 0;
			obj.Columns = new List<CsvFormatColumn>()
			{
				new CsvFormatColumn("RowNum", "RowNum", idx++, null, false),
				...
				new CsvFormatColumn("InvoiceNumber", "InvoiceNumber", idx++, null, false),
				new CsvFormatColumn("QboDocNumber", "", idx++, null, false),
				new CsvFormatColumn("SalesOrderUuid", "", idx++, null, false),
				new CsvFormatColumn("OrderNumber", "", idx++, null, false),
				new CsvFormatColumn("InvoiceType", "", idx++, null, false),
				new CsvFormatColumn("InvoiceStatus", "InvoiceStatus", idx++, null, false),
				new CsvFormatColumn("InvoiceDate", "InvoiceDate", idx++, FormatType.Date, false),
				new CsvFormatColumn("InvoiceTime", "InvoiceTime", idx++, FormatType.Time, false),
				...
				new CsvFormatColumn("CustomerCode", "CustomerCode", idx++, null, false),
				...
				new CsvFormatColumn("InvoiceSourceCode", "", idx++, null, false),
		...
		protected virtual void InitInvoiceHeaderInfo()
		{
			var obj = this.InitParentObject<InvoiceHeaderInfoDto>();
			var idx = 0;
			obj.Columns = new List<CsvFormatColumn>()
			{
		...
		protected virtual void InitInvoiceHeaderAttributes()
		{
			var obj = this.InitParentObject<InvoiceHeaderAttributesDto>();
			var idx = 0;
			obj.Columns = new List<CsvFormatColumn>()
			{
		...
		protected virtual void InitInvoiceItems()
		{
			var obj = this.InitParentObject<InvoiceItemsDto>();
			var idx = 0;
			obj.Columns = new List<CsvFormatColumn>()
			{
				new CsvFormatColumn("InvoiceItemsUuid", "InvoiceItemsUuid", idx++, null, false),
				new CsvFormatColumn("Seq", "", idx++, null, false),
				new CsvFormatColumn("InvoiceItemType", "", idx++, null, false),
				new CsvFormatColumn("InvoiceItemStatus", "", idx++, null, false),
				...
				new CsvFormatColumn("SKU", "SKU", idx++, null, false),
				...
				new CsvFormatColumn("OrderQty", "OrderQty", idx++, FormatType.Qty, false),
				new CsvFormatColumn("ShipQty", "ShipQty", idx++, FormatType.Qty, false),
				new CsvFormatColumn("CancelledQty", "CancelledQty", idx++, FormatType.Qty, false),
				new CsvFormatColumn("OpenQty", "", idx++, FormatType.Qty, false),
				new CsvFormatColumn("PriceRule", "", idx++, null, false),
				new CsvFormatColumn("Price", "Price", idx++, FormatType.Price, false),
				...
				new CsvFormatColumn("OrderAmount", "", idx++, FormatType.Amount, false),
