...
namespace DigitBridge.CommerceCentral.ERPMdl
{
    ...
    /// </summary>
    [Serializable()]
    public partial class InvoiceReturnIOManager : IInvoiceReturnIOManager, IMessage
    {
        public InvoiceReturnIOManager(IDataBaseFactory dbFactory)
        {
            SetDataBaseFactory(dbFactory);
            Format = new InvoiceReturnIOFormat();
        }
        ...
        [XmlIgnore, JsonIgnore]
        public InvoiceReturnIOFormat Format { get; set; }

        [XmlIgnore, JsonIgnore]
        protected InvoiceReturnIOCsv _InvoiceTransactionIOCsv;
        [XmlIgnore, JsonIgnore]
        public InvoiceReturnIOCsv InvoiceTransactionIOCsv
        {
            get
            {
                if (_InvoiceTransactionIOCsv is null)
                    _InvoiceTransactionIOCsv = new InvoiceReturnIOCsv(Format);
