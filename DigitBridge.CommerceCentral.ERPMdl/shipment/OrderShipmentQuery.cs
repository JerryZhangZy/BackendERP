...
namespace DigitBridge.CommerceCentral.ERPMdl
{
    public class OrderShipmentQuery : QueryObject<OrderShipmentQuery>
    {
        ...
        protected QueryFilter<long> _OrderDCAssignmentNum = new QueryFilter<long>("OrderDCAssignmentNum", "OrderDCAssignmentNum", PREFIX, FilterBy.eq, -1);
        public QueryFilter<long> OrderDCAssignmentNum => _OrderDCAssignmentNum;

        protected QueryFilter<long> _CentralOrderNum = new QueryFilter<long>("CentralOrderNum", "CentralOrderNum", PREFIX, FilterBy.eq, -1);
        ...
        protected QueryFilter<string> _ShipmentID = new QueryFilter<string>("ShipmentID", "ShipmentID", PREFIX, FilterBy.cn, string.Empty, isNVarChar: true);
        ...
        protected QueryFilter<int> _ShipmentType = new QueryFilter<int>("ShipmentType", "ShipmentType", PREFIX, FilterBy.eq,-1);
