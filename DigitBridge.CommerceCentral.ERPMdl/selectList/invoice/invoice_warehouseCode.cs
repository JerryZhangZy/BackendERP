...
{
    public partial class invoice_warehouseCode : SelectListBase
    {
        public override string Name => "invoice_warehouseCode";

        public invoice_warehouseCode(IDataBaseFactory dbFactory) : base(dbFactory) { }
