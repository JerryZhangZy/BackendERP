...
{
    public partial class invoice_refNum : SelectListBase
    {
        public override string Name => "invoice_refNum";

        public invoice_refNum(IDataBaseFactory dbFactory) : base(dbFactory) { }
