...
{
    public partial class invoice_shippingCarrier : SelectListBase
    {
        public override string Name => "invoice_shippingCarrier";

        public invoice_shippingCarrier(IDataBaseFactory dbFactory) : base(dbFactory) { }
