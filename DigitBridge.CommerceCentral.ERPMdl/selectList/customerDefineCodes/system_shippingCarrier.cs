...
{
    public partial class system_shippingCarrier : SelectListBase
    {
        public override string Name => "system_shippingCarrier";

        public system_shippingCarrier(IDataBaseFactory dbFactory) : base(dbFactory) { }
