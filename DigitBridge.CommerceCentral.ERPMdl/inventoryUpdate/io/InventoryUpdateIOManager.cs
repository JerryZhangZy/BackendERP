...
namespace DigitBridge.CommerceCentral.ERPMdl
{
    ...
    /// </summary>
    [Serializable()]
    public partial class InventoryUpdateIOManager : IInventoryUpdateIOManager, IMessage
    {
        public InventoryUpdateIOManager(IDataBaseFactory dbFactory)
        {
            SetDataBaseFactory(dbFactory);
            Format = new InventoryUpdateIOFormat();
        }
        ...
        [XmlIgnore, JsonIgnore]
        protected InventoryUpdateManager _InventoryUpdateManager;
        [XmlIgnore, JsonIgnore]
        public InventoryUpdateManager InventoryUpdateManager
        {
            get
            {
                if (_InventoryUpdateManager is null)
                    _InventoryUpdateManager = new InventoryUpdateManager(dbFactory);
                return _InventoryUpdateManager;
            }
        }
        #endregion
        ...
        [XmlIgnore, JsonIgnore]
        public InventoryUpdateIOFormat Format { get; set; }

        [XmlIgnore, JsonIgnore]
        protected InventoryUpdateIOCsv _InventoryUpdateIOCsv;
        [XmlIgnore, JsonIgnore]
        public InventoryUpdateIOCsv InventoryUpdateIOCsv
        {
            get
            {
                if (_InventoryUpdateIOCsv is null)
                    _InventoryUpdateIOCsv = new InventoryUpdateIOCsv(Format);
                return _InventoryUpdateIOCsv;
            }
        }
        ...
        public async Task<bool> ImportAsync(ImportExportFilesPayload payload)
        {
            ...
            var manager = InventoryUpdateManager;
        ...
        /// Import csv file stream to IList of Dto, depend on format setting
        /// </summary>
        public async Task<IList<InventoryUpdateDataDto>> ImportAsync(Stream stream)
        {
            if (stream == null) return null;
            var result = await InventoryUpdateIOCsv.ImportAsync(stream);
        ...
        /// </summary>
        public async Task<IList<InventoryUpdateDataDto>> ImportAllColumnsAsync(Stream stream)
        {
            if (stream == null) return null;
            var result = await InventoryUpdateIOCsv.ImportAllColumnsAsync(stream);
            return result.ToList();
        }
        ...
        /// </summary>
        public async Task<byte[]> ExportAsync(IList<InventoryUpdateDataDto> dtos)
        {
            if (dtos == null || dtos.Count == 0)
                return null;
            return await InventoryUpdateIOCsv.ExportAsync(dtos);
        }

        /// <summary>
        /// Export Dto list to csv file stream, expot all columns
        /// </summary>
        public async Task<byte[]> ExportAllColumnsAsync(IList<InventoryUpdateDataDto> dtos)
        {
            if (dtos == null || dtos.Count == 0)
                return null;
            return await InventoryUpdateIOCsv.ExportAllColumnsAsync(dtos);
        }
