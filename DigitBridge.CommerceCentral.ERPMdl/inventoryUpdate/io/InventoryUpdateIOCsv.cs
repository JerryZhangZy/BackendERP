...
{
    /// <summary>
    /// Represents a InventoryUpdateIOCsv Class.
    /// NOTE: This class is generated from a T4 template Once - you you wanr re-generate it, you need delete cs file and generate again
    /// </summary>
    [Serializable()]
    public partial class InventoryUpdateIOCsv : CsvHelper<InventoryUpdateDataDto>
    {
        public InventoryUpdateIOCsv(InventoryUpdateIOFormat format): base(format)
        {
        }
        ...
        public override void GetMapper()
        {
            ...
            {
				new CsvFormatMapper<InventoryUpdateHeaderDto>(Format),
				new CsvFormatMapper<InventoryUpdateItemsDto>(Format),
            };
        }
        ...
        /// </summary>
        public override async Task ReadEntitiesAsync(CsvReader csv, IList<InventoryUpdateDataDto> data)
        {
            var hasReadSummary = false;
            var headerFound = false;
            var dto = new InventoryUpdateDataDto().NewData();
                ...
                else
                {
                    ...
                    if (keyValues != null)
                    {
                        ...
                        if (!keyValues.IsEqualTo(currentKeyValues))
                        {
                            ...
                            {
                                data.Add(dto);
                                dto = new InventoryUpdateDataDto().NewData();
                                hasReadSummary = false;
                            }
                        }
        ...
        /// </summary>
        protected virtual async Task<bool> ReadSummaryRecordAsync(CsvReader csv, InventoryUpdateDataDto dto)
        {
            try
            {
        ...
        /// </summary>
        protected virtual async Task<bool> ReadDetailRecordAsync(CsvReader csv, InventoryUpdateDataDto dto)
        {
            try
            {
				var ln = csv.GetRecord<InventoryUpdateItemsDto>();
				if (ln == null || !ln.HasSKU)
					return false;
				dto.InventoryUpdateItems.Add(ln);
                return true;
            }
            catch (Exception e)
            {
        ...
        /// </summary>
        public override async Task<byte[]> ExportAsync(IEnumerable<InventoryUpdateDataDto> datas)
        {
        ...
        /// </summary>
        protected virtual IList<string> GetHeader(IEnumerable<InventoryUpdateDataDto> datas)
        {
            if (Format == null || datas == null || !datas.Any()) return null;
			...
			// build InventoryUpdateHeader header
			var (header1, values1) = Format.GetHeaderAndData<InventoryUpdateHeaderDto>(dataList[0].InventoryUpdateHeader);
			if (header1 != null) headers.AddRange(header1);
			
			// build InventoryUpdateItems header
			var (header2, values2) = Format.GetHeaderAndData<InventoryUpdateItemsDto>(dataList[0].InventoryUpdateItems[0]);
        ...
        /// </summary>
        protected virtual IList<IList<string>> GetDataLines(InventoryUpdateDataDto data)
        {
			...
			// build InventoryUpdateHeader data
			var (header1, values1) = Format.GetHeaderAndData<InventoryUpdateHeaderDto>(data.InventoryUpdateHeader);
			if (values1 != null) lnSummary.AddRange(values1);
			
			// build InventoryUpdateItems data
			foreach (var item in data.InventoryUpdateItems)
			{
				if (item == null) continue;
				var (headerLine, valuesLine) = Format.GetHeaderAndData<InventoryUpdateItemsDto>(item);
