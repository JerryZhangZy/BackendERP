...
{
    /// <summary>
    /// Represents a SystemSettingHelper SQL Helper Static Class.
...
/*
            var sql = $@"
SELECT COUNT(1) FROM SystemSetting tbl
...
";
        ...
        {
            var sql = $@"
SELECT RowNum FROM SystemSetting tbl
WHERE MasterAccountNum = @masterAccountNum
AND ProfileNum = @profileNum";
