...
*/
        ...
        public static async Task<bool> ExistNumberAsync(string number)
        {
/*
            var sql = $@"
SELECT COUNT(1) FROM VendorAddress tbl
...
*/
        ...
        public static async Task<long> GetRowNumByAddressUuidAsync(IDataBaseFactory dbFactory, string addressUuid)
        {
            ...
            ";
                return await SqlQuery.ExecuteScalarAsync<long>(sql,
                    addressUuid.ToSqlParameter("addressUuid")
                );
            }
        }
    }
