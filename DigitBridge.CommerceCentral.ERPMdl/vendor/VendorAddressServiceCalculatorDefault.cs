...
{
    /// <summary>
    /// Represents a default VendorAddressService Calculator class.
    /// </summary>
    public partial class VendorAddressServiceCalculatorDefault : ICalculator<VendorAddressData>
    {
        protected IDataBaseFactory dbFactory { get; set; }

        public VendorAddressServiceCalculatorDefault(IMessage serviceMessage, IDataBaseFactory dbFactory)
        {
            this.ServiceMessage = serviceMessage;
            this.dbFactory = dbFactory;
        }

        public virtual void PrepareData(VendorAddressData  data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
        ...
        public virtual bool SetDefault(VendorAddressData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
        ...
        public virtual bool SetDefaultSummary(VendorAddressData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (data is null)
                return false;
        ...
        public virtual bool SetDefaultDetail(VendorAddressData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (data is null)
                return false;
        ...
        /* This is generated sample code
        protected virtual bool SetDefault(InvoiceItems item, VendorAddressData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (item is null || item.IsEmpty)
                return false;
        ...
        */
        ...
        public virtual bool Calculate(VendorAddressData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            PrepareData(data);
        ...
        public virtual bool CalculateSummary(VendorAddressData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (data is null)
                return false;
        ...
        public virtual bool CalculateDetail(VendorAddressData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (data is null)
                return false;
        ...
        //TODO: add set default for detail line logic
        /* This is generated sample code
        protected virtual bool CalculateDetail(InvoiceItems item, VendorAddressData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (item is null || item.IsEmpty)
                return false;
