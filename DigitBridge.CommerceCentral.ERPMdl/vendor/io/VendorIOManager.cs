...
namespace DigitBridge.CommerceCentral.ERPMdl
{
    ...
    public partial class VendorIOManager : IVendorIOManager, IMessage
    {
        ...
        public VendorManager VendorManager
        {
            get
            {
                if (_VendorManager is null)
                    _VendorManager = new VendorManager(dbFactory);
        ...
        /// Import csv file stream to IList of Dto, depend on format setting
        /// </summary>
        public async Task<IList<VendorDataDto>> ImportAsync(byte[] buffer)
        {
