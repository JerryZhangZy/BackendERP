...
{
    /// <summary>
    /// Represents a CustomerIOCsv Class.
    /// NOTE: This class is generated from a T4 template Once - you you wanr re-generate it, you need delete cs file and generate again
    /// </summary>
    [Serializable()]
    public partial class CustomerIOCsv : CsvHelper<CustomerDataDto>
    {
        public CustomerIOCsv(CustomerIOFormat format): base(format)
        {
        }
        ...
        public override void GetMapper()
        {
            ...
            {
				new CsvFormatMapper<CustomerDto>(Format),
				new CsvFormatMapper<CustomerAddressDto>(Format),
				new CsvFormatMapper<CustomerAttributesDto>(Format),
            };
        }
        ...
        /// </summary>
        public override async Task ReadEntitiesAsync(CsvReader csv, IList<CustomerDataDto> data)
        {
            var hasReadSummary = false;
            var headerFound = false;
            var dto = new CustomerDataDto().NewData();
                ...
                else
                {
                    ...
                    if (keyValues != null)
                    {
                        ...
                        if (!keyValues.IsEqualTo(currentKeyValues))
                        {
                            ...
                            {
                                data.Add(dto);
                                dto = new CustomerDataDto().NewData();
                                hasReadSummary = false;
                            }
                        }
        ...
        /// </summary>
        protected virtual async Task<bool> ReadSummaryRecordAsync(CsvReader csv, CustomerDataDto dto)
        {
            try
            {
        ...
        /// </summary>
        protected virtual async Task<bool> ReadDetailRecordAsync(CsvReader csv, CustomerDataDto dto)
        {
            try
            {
				var ln = csv.GetRecord<CustomerAddressDto>();
				if (ln == null)
					return false;
				dto.CustomerAddress.Add(ln);
                return true;
            }
            catch (Exception e)
            {
        ...
        /// </summary>
        public override async Task<byte[]> ExportAsync(IEnumerable<CustomerDataDto> datas)
        {
        ...
        /// </summary>
        protected virtual IList<string> GetHeader(IEnumerable<CustomerDataDto> datas)
        {
            if (Format == null || datas == null || !datas.Any()) return null;
        ...
        /// </summary>
        protected virtual IList<IList<string>> GetDataLines(CustomerDataDto data)
        {
			...
			// build Customer data
			var (header1, values1) = Format.GetHeaderAndData<CustomerDto>(data.Customer);
			if (values1 != null) lnSummary.AddRange(values1);
			
			// build CustomerAddress data
			foreach (var item in data.CustomerAddress)
			{
				if (item == null) continue;
				var (headerLine, valuesLine) = Format.GetHeaderAndData<CustomerAddressDto>(item);
				var ln = new List<string>(lnSummary);
				if (valuesLine != null) ln.AddRange(valuesLine);
				lines.Add(ln);
			}
			// build CustomerAttributes data
			var (header3, values3) = Format.GetHeaderAndData<CustomerAttributesDto>(data.CustomerAttributes);
