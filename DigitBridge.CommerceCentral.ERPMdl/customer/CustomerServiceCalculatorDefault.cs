...
{
    /// <summary>
    /// Represents a default CustomerService Calculator class.
    /// </summary>
    public partial class CustomerServiceCalculatorDefault : ICalculator<CustomerData>
    {
        ...
        public virtual void PrepareData(CustomerData  data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
        ...
        public virtual bool SetDefault(CustomerData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
        ...
        public virtual bool SetDefaultSummary(CustomerData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (data is null)
                return false;
        ...
        public virtual bool SetDefaultDetail(CustomerData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (data is null)
                return false;
        ...
        /* This is generated sample code
        protected virtual bool SetDefault(InvoiceItems item, CustomerData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (item is null || item.IsEmpty)
                return false;
        ...
        */
        ...
        public virtual bool Calculate(CustomerData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            PrepareData(data);
        ...
        public virtual bool CalculateSummary(CustomerData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (data is null)
                return false;
        ...
        public virtual bool CalculateDetail(CustomerData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (data is null)
                return false;
        ...
        //TODO: add set default for detail line logic
        /* This is generated sample code
        protected virtual bool CalculateDetail(InvoiceItems item, CustomerData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (item is null || item.IsEmpty)
                return false;
