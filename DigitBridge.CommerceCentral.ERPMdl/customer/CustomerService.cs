...
namespace DigitBridge.CommerceCentral.ERPMdl
{
    public partial class CustomerService
    {
        ...
        /// This processing will load data by RowNum of Dto, and then use change data by Dto.
        /// </summary>
        public virtual async Task<bool> ImportAsync(CustomerPayload payload)
        {
            if (payload is null || !payload.HasCustomer)
                return false;
            #region delete
        ...
        public async Task<Customer> GetCustomerBySourceCodeAsync(int masterAccountNum, int profileNum, string sourceCode)
        {
            return await dbFactory.GetByAsync<Customer>(
                $"WHERE MasterAccountNum = @0 AND ProfileNum = @1 AND SourceCode = @2",
                masterAccountNum,
                profileNum,
                sourceCode);
