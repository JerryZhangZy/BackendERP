...
namespace DigitBridge.CommerceCentral.ERPMdl
{
    public class CustomerQuery : QueryObject<CustomerQuery>
    {
        ...
        protected QueryFilter<string> _Contact = new QueryFilter<string>("Contact", "Contact", PREFIX, FilterBy.bw, string.Empty, isNVarChar: true);
        public QueryFilter<string> Contact => _Contact;

        protected QueryFilter<string> _Phone1 = new QueryFilter<string>("Phone1", "Phone1", PREFIX, FilterBy.bw, string.Empty, isNVarChar: true);
        ...
        protected QueryFilter<string> _WebSite = new QueryFilter<string>("WebSite", "WebSite", PREFIX, FilterBy.bw, string.Empty, isNVarChar: true);
        ...
        protected QueryFilter<string> _BusinessType = new QueryFilter<string>("BusinessType", "BusinessType", PREFIX, FilterBy.bw, string.Empty, isNVarChar: true);
        ...
        public QueryFilter<DateTime> FirstDateTo => _FirstDateTo;

        protected QueryFilter<string> _Priority = new QueryFilter<string>("Priority", "Priority", PREFIX, FilterBy.bw, string.Empty, isNVarChar: true);
        public QueryFilter<string> Priority => _Priority;

        protected QueryFilter<string> _Area = new QueryFilter<string>("Area", "Area", PREFIX, FilterBy.bw, string.Empty, isNVarChar: true);
        public QueryFilter<string> Area => _Area;

        protected QueryFilter<string> _Region = new QueryFilter<string>("Region", "Region", PREFIX, FilterBy.bw, string.Empty, isNVarChar: true);
        public QueryFilter<string> Region => _Region;

        protected QueryFilter<string> _Districtn = new QueryFilter<string>("Districtn", "Districtn", PREFIX, FilterBy.bw, string.Empty, isNVarChar: true);
        public QueryFilter<string> Districtn => _Districtn;

        protected QueryFilter<string> _Zone = new QueryFilter<string>("Zone", "Zone", PREFIX, FilterBy.bw, string.Empty, isNVarChar: true);
        public QueryFilter<string> Zone => _Zone;

        protected QueryFilter<string> _ClassCode = new QueryFilter<string>("ClassCode", "ClassCode", PREFIX, FilterBy.bw, string.Empty, isNVarChar: true);
        public QueryFilter<string> ClassCode => _ClassCode;

        protected QueryFilter<string> _DepartmentCode = new QueryFilter<string>("DepartmentCode", "DepartmentCode", PREFIX, FilterBy.bw, string.Empty, isNVarChar: true);
        public QueryFilter<string> DepartmentCode => _DepartmentCode;

        protected QueryFilter<string> _DivisionCode = new QueryFilter<string>("DivisionCode", "DivisionCode", PREFIX, FilterBy.bw, string.Empty, isNVarChar: true);
        public QueryFilter<string> DivisionCode => _DivisionCode;

        protected QueryFilter<string> _SourceCode = new QueryFilter<string>("SourceCode", "SourceCode", PREFIX, FilterBy.bw, string.Empty, isNVarChar: true);
