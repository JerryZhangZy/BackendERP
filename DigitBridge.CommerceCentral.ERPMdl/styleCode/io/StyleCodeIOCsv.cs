...
{
    /// <summary>
    /// Represents a StyleCodeIOCsv Class.
    /// NOTE: This class is generated from a T4 template Once - you you wanr re-generate it, you need delete cs file and generate again
    /// </summary>
    [Serializable()]
    public partial class StyleCodeIOCsv : CsvHelper<StyleCodeDataDto>
    {
        public StyleCodeIOCsv(StyleCodeIOFormat format): base(format)
        {
        }
        public StyleCodeIOCsv(StyleCodeIOFormat format, IMessage serviceMessage): base(format, serviceMessage)
        {
        }
        ...
        public override void GetMapper()
        {
            ...
            {
				new CsvFormatMapper<StyleCodeDto>(Format),
				new CsvFormatMapper<StyleCodeAttributesDto>(Format),
            };
        }
        ...
        /// </summary>
        public override async Task ReadEntitiesAsync(CsvReader csv, IList<StyleCodeDataDto> data)
        {
            var hasReadSummary = false;
            var headerFound = false;
            var dto = new StyleCodeDataDto().NewData();
                ...
                else
                {
                    ...
                    if (keyValues != null)
                    {
                        ...
                        if (!keyValues.IsEqualTo(currentKeyValues))
                        {
                            ...
                            {
                                data.Add(dto);
                                dto = new StyleCodeDataDto().NewData();
                                hasReadSummary = false;
                            }
                        }
        ...
        /// </summary>
        protected virtual async Task<bool> ReadSummaryRecordAsync(CsvReader csv, StyleCodeDataDto dto)
        {
            try
            {
				dto.StyleCode = csv.GetRecord<StyleCodeDto>();
				dto.StyleCodeAttributes = csv.GetRecord<StyleCodeAttributesDto>();
                return true;
            }
            catch (Exception e)
            {
        ...
        /// </summary>
        protected virtual async Task<bool> ReadDetailRecordAsync(CsvReader csv, StyleCodeDataDto dto)
        {
            try
            {
                return true;
        ...
        /// </summary>
        public override async Task<byte[]> ExportAsync(IEnumerable<StyleCodeDataDto> datas)
        {
        ...
        /// </summary>
        protected virtual IList<string> GetHeader(IEnumerable<StyleCodeDataDto> datas)
        {
            if (Format == null || datas == null || !datas.Any()) return null;
			...
			// build StyleCode header
			var (header1, values1) = Format.GetHeaderAndData<StyleCodeDto>(dataList[0].StyleCode);
			if (header1 != null) headers.AddRange(header1);
			
			// build StyleCodeAttributes header
			var (header2, values2) = Format.GetHeaderAndData<StyleCodeAttributesDto>(dataList[0].StyleCodeAttributes);
        ...
        /// </summary>
        protected virtual IList<IList<string>> GetDataLines(StyleCodeDataDto data)
        {
			...
			// build StyleCode data
			var (header1, values1) = Format.GetHeaderAndData<StyleCodeDto>(data.StyleCode);
			if (values1 != null) lnSummary.AddRange(values1);
			
			// build StyleCodeAttributes data
			var (header2, values2) = Format.GetHeaderAndData<StyleCodeAttributesDto>(data.StyleCodeAttributes);
