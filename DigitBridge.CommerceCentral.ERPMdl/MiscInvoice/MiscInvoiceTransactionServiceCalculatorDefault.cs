...
{
    /// <summary>
    /// Represents a default MiscInvoiceTransactionService Calculator class.
    /// </summary>
    public partial class MiscInvoiceTransactionServiceCalculatorDefault : ICalculator<MiscInvoiceTransactionData>
    {
        protected IDataBaseFactory dbFactory { get; set; }

        public MiscInvoiceTransactionServiceCalculatorDefault(IMessage serviceMessage, IDataBaseFactory dbFactory)
        {
            this.ServiceMessage = serviceMessage;
            this.dbFactory = dbFactory;
        }

        public virtual void PrepareData(MiscInvoiceTransactionData  data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
        ...
        public virtual bool SetDefault(MiscInvoiceTransactionData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
        ...
        public virtual bool SetDefaultSummary(MiscInvoiceTransactionData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (data is null)
                return false;
            ...
            var sum = data.MiscInvoiceTransaction;
        ...
        public virtual bool SetDefaultDetail(MiscInvoiceTransactionData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (data is null)
                return false;
        ...
        /* This is generated sample code
        protected virtual bool SetDefault(InvoiceItems item, MiscInvoiceTransactionData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (item is null || item.IsEmpty)
                return false;
        ...
        */
        ...
        public virtual bool Calculate(MiscInvoiceTransactionData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            PrepareData(data);
        ...
        public virtual bool CalculateSummary(MiscInvoiceTransactionData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (data is null)
                return false;
        ...
        public virtual bool CalculateDetail(MiscInvoiceTransactionData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (data is null)
                return false;
        ...
        //TODO: add set default for detail line logic
        /* This is generated sample code
        protected virtual bool CalculateDetail(InvoiceItems item, MiscInvoiceTransactionData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (item is null || item.IsEmpty)
                return false;
