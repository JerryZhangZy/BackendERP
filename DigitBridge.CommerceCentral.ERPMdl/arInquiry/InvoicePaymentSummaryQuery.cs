...
{
    public class InvoicePaymentSummaryQuery : QueryObject<InvoicePaymentSummaryQuery>
    {
        ...
        public InvoicePaymentSummaryQuery() : base(PREFIX)
        {
        ...
        {
            _TransDateFrom.FilterValue = new DateTime(DateTime.Today.Year, 1, 1);
