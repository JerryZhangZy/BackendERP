...
namespace DigitBridge.CommerceCentral.ERPMdl
{
    ...
    /// </summary>
    public partial class SalesOrderImportDefault : IPrepare<SalesOrderService, SalesOrderData, SalesOrderDataDto>
    {
        public SalesOrderImportDefault(SalesOrderService salesOrderService)
        {
