...
{
    /// <summary>
    /// Represents a ApInvoiceIOCsv Class.
    /// NOTE: This class is generated from a T4 template Once - you you wanr re-generate it, you need delete cs file and generate again
    /// </summary>
    [Serializable()]
    public partial class ApInvoiceIOCsv : CsvHelper<ApInvoiceDataDto>
    {
        public ApInvoiceIOCsv(ApInvoiceIOFormat format): base(format)
        {
        }
        ...
        public override void GetMapper()
        {
            ...
            {
				new CsvFormatMapper<ApInvoiceHeaderDto>(Format),
				new CsvFormatMapper<ApInvoiceHeaderInfoDto>(Format),
				new CsvFormatMapper<ApInvoiceHeaderAttributesDto>(Format),
				new CsvFormatMapper<ApInvoiceItemsDto>(Format),
            };
        }
        ...
        /// </summary>
        public override async Task ReadEntitiesAsync(CsvReader csv, IList<ApInvoiceDataDto> data)
        {
            var hasReadSummary = false;
            var headerFound = false;
            var dto = new ApInvoiceDataDto().NewData();
                ...
                else
                {
                    ...
                    if (keyValues != null)
                    {
                        ...
                        if (!keyValues.IsEqualTo(currentKeyValues))
                        {
                            ...
                            {
                                data.Add(dto);
                                dto = new ApInvoiceDataDto().NewData();
                                hasReadSummary = false;
                            }
                        }
        ...
        /// </summary>
        protected virtual async Task<bool> ReadSummaryRecordAsync(CsvReader csv, ApInvoiceDataDto dto)
        {
            try
            {
				dto.ApInvoiceHeader = csv.GetRecord<ApInvoiceHeaderDto>();
				dto.ApInvoiceHeaderInfo = csv.GetRecord<ApInvoiceHeaderInfoDto>();
				dto.ApInvoiceHeaderAttributes = csv.GetRecord<ApInvoiceHeaderAttributesDto>();
                return true;
            }
            catch (Exception e)
            {
        ...
        /// </summary>
        protected virtual async Task<bool> ReadDetailRecordAsync(CsvReader csv, ApInvoiceDataDto dto)
        {
            try
            {
				var ln = csv.GetRecord<ApInvoiceItemsDto>();
				if (ln == null)
					return false;
				dto.ApInvoiceItems.Add(ln);
                return true;
            }
            catch (Exception e)
            {
        ...
        /// </summary>
        public override async Task<byte[]> ExportAsync(IEnumerable<ApInvoiceDataDto> datas)
        {
        ...
        /// </summary>
        protected virtual IList<string> GetHeader(IEnumerable<ApInvoiceDataDto> datas)
        {
            if (Format == null || datas == null || !datas.Any()) return null;
			...
			// build ApInvoiceHeader header
			var (header1, values1) = Format.GetHeaderAndData<ApInvoiceHeaderDto>(dataList[0].ApInvoiceHeader);
			if (header1 != null) headers.AddRange(header1);
			
			// build ApInvoiceHeaderInfo header
			var (header2, values2) = Format.GetHeaderAndData<ApInvoiceHeaderInfoDto>(dataList[0].ApInvoiceHeaderInfo);
			if (header2 != null) headers.AddRange(header2);
			
			// build ApInvoiceHeaderAttributes header
			var (header3, values3) = Format.GetHeaderAndData<ApInvoiceHeaderAttributesDto>(dataList[0].ApInvoiceHeaderAttributes);
			if (header3 != null) headers.AddRange(header3);
			
			// build ApInvoiceItems header
			var (header4, values4) = Format.GetHeaderAndData<ApInvoiceItemsDto>(dataList[0].ApInvoiceItems[0]);
        ...
        /// </summary>
        protected virtual IList<IList<string>> GetDataLines(ApInvoiceDataDto data)
        {
			...
			// build ApInvoiceHeader data
			var (header1, values1) = Format.GetHeaderAndData<ApInvoiceHeaderDto>(data.ApInvoiceHeader);
			if (values1 != null) lnSummary.AddRange(values1);
			
			// build ApInvoiceHeaderInfo data
			var (header2, values2) = Format.GetHeaderAndData<ApInvoiceHeaderInfoDto>(data.ApInvoiceHeaderInfo);
			if (values2 != null) lnSummary.AddRange(values2);
			
			// build ApInvoiceHeaderAttributes data
			var (header3, values3) = Format.GetHeaderAndData<ApInvoiceHeaderAttributesDto>(data.ApInvoiceHeaderAttributes);
			if (values3 != null) lnSummary.AddRange(values3);
			
			// build ApInvoiceItems data
			foreach (var item in data.ApInvoiceItems)
			{
				if (item == null) continue;
				var (headerLine, valuesLine) = Format.GetHeaderAndData<ApInvoiceItemsDto>(item);
