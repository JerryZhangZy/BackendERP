...
{
    /// <summary>
    /// Represents a default ApTransactionService Calculator class.
    /// </summary>
    public partial class ApTransactionServiceCalculatorDefault : ICalculator<ApTransactionData>
    {
        protected IDataBaseFactory dbFactory { get; set; }

        public ApTransactionServiceCalculatorDefault(IMessage serviceMessage, IDataBaseFactory dbFactory)
        {
        ...
        /* This is generated sample code
        protected virtual bool SetDefault(InvoiceItems item, ApTransactionData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (item is null || item.IsEmpty)
                return false;
        ...
        */
        ...
        //TODO: add set default for detail line logic
        /* This is generated sample code
        protected virtual bool CalculateDetail(InvoiceItems item, ApTransactionData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (item is null || item.IsEmpty)
                return false;
