...
{
    /// <summary>
    /// Represents a default ApInvoiceService Calculator class.
    /// </summary>
    public partial class ApInvoiceServiceCalculatorDefault : ICalculator<ApInvoiceData>
    {
        ...
        public virtual void PrepareData(ApInvoiceData  data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
        ...
        public virtual bool SetDefaultDetail(ApInvoiceData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (data is null)
                return false;
        ...
        */
        ...
        public virtual bool CalculateSummary(ApInvoiceData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (data is null)
                return false;
        ...
        public virtual bool CalculateDetail(ApInvoiceData data, ProcessingMode processingMode = ProcessingMode.Edit)
        {
            if (data is null)
                return false;
