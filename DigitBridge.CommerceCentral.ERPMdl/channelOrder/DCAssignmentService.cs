...
namespace DigitBridge.CommerceCentral.ERPMdl
{
    public partial class DCAssignmentService
    {
        ...
        public virtual async Task<bool> AddAsync(DCAssignmentPayload payload)
        {
            ...
            if (!(await ValidateAsync(payload.DCAssignment)))
                return false;
        ...
        public virtual async Task<bool> UpdateAsync(DCAssignmentDataDto dto)
        {
            ...
            // load data 
            await GetDataAsync(dto.OrderDCAssignmentHeader.RowNum.ToLong());
        ...
        public virtual async Task<bool> UpdateAsync(DCAssignmentPayload payload)
        {
            ...
            // load data 
            await GetDataAsync(payload.DCAssignment.OrderDCAssignmentHeader.RowNum.ToLong());
...
";
        ...
        {
            var sql = $@"
UPDATE oln SET CentralOrderUuid = ohd.CentralOrderUuid
FROM OrderHeader ohd
INNER JOIN OrderDCAssignmentLine oln ON (oln.CentralOrderNum = ohd.CentralOrderNum)
