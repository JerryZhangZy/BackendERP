...
{
    /// <summary>
    /// Represents a Event_ERP SQL Helper Static Class.
    /// NOTE: This class is generated from a T4 template Once - you want re-generate it, you need delete cs file and generate again
    /// </summary>
    public static class Event_ERPHelper
    {
        public static readonly string TableName = "Event_ERP";
        public static readonly string TableAllies = "eer";
        ...
        public static string ERPEventType(string tableAllies = null, string name = null, bool camelCase = true) => $"{tableAllies ?? TableAllies}.ERPEventType AS {name ?? "ERPEventType".ToCamelCase(camelCase)} ";
...
{allies}ERPEventType AS ERPEventType,
