...
namespace DigitBridge.CommerceCentral.ERPDb
{
    ...
    /// </summary>
    public static class EventERPDataDtoExtension
    {
        /// <summary>
        /// Merge EventERPDataDto header objects to one dynamic object
        /// </summary>
        /// <param name="dto">EventERPDataDto object to merge data</param>
        ...
        public static IEnumerable<dynamic> MergeHeaderRecord(this EventERPDataDto dto, bool withHeaderText = false)
        {
        ...
        public static IEnumerable<dynamic> MergeDetailRecord(this EventERPDataDto dto, bool withHeaderText = false)
        {
            return null;
            //TODO change to merge Dto children object
            //var result = new List<dynamic>();
        ...
        public static IList<EventERPDataDto> GetFakerData(this EventERPDataDto dto, int count)
        {
            var obj = new EventERPDataDto();
            var datas = new List<EventERPDataDto>();
        ...
        public static EventERPDataDto GetFakerData(this EventERPDataDto dto)
        {
            var data = new EventERPDataDto();
			data.Event_ERP = new Event_ERPDto().GetFaker().Generate();
            return data;
        }


		/// <summary>
		/// Get faker object for Event_ERPDto
		/// </summary>
		/// <param name="dto">Event_ERPDto</param>
		/// <returns>Faker object use to generate data</returns>
		public static Faker<Event_ERPDto> GetFaker(this Event_ERPDto dto)
		{
			#region faker data rules
			return new Faker<Event_ERPDto>()
