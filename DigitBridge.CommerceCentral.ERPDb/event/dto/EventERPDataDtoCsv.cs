...
{
    /// <summary>
    /// Represents a EventERPDataDtoCsv Class.
    /// NOTE: This class is generated from a T4 template Once - you you wanr re-generate it, you need delete cs file and generate again
    /// </summary>
    [Serializable()]
    public partial class EventERPDataDtoCsv : CsvHelper<EventERPDataDto>
    {
        ...
        {
			context.RegisterClassMap(new CsvAutoMapper<Event_ERPDto>());
        }
        
        protected override void WriteCsv(EventERPDataDto data, CsvWriter csv)
        {
        ...
        public override void ReadEntities(CsvReader csv, IList<EventERPDataDto> data)
        {
            var isFirst = true;
            EventERPDataDto dto = new EventERPDataDto();
            while (csv.Read())
            {
                // it is header line
                ...
                switch (csv.GetField(0))
                {
                    case "H":
                        if (!isFirst)
                        {
                            if (dto != null && dto.HasEvent_ERP)
                                data.Add(dto);
                            dto = new EventERPDataDto();
                            isFirst = false;
                        }
                        dto. Event_ERP = csv.GetRecord<Event_ERPDto>();
                        break;
                    //case "L":
