...
namespace DigitBridge.CommerceCentral.ERPDb
{
    ...
    [UniqueId("EventUuid")]
    [DtoName("Event_ERPDto")]
    public partial class Event_ERP : TableRepository<Event_ERP, long>
    {

        public Event_ERP() : base() {}
        public Event_ERP(IDataBaseFactory dbFactory): base(dbFactory) {}
        ...
        [Column("ERPEventType",SqlDbType.Int,NotNull=true,IsDefault=true)]
        private int _eRPEventType;
		...
		/// </summary>
        public virtual int ERPEventType
        {
            get
            {
				return _eRPEventType; 
            }
            set
            {
				_eRPEventType = value; 
				OnPropertyChanged("ERPEventType", value);
            }
        }
		...
		private EventERPData Parent { get; set; }
		public EventERPData GetParent() => Parent;
		public Event_ERP SetParent(EventERPData parent)
		{
			Parent = parent;
			return this;
		}
        ...
        public override Event_ERP Clear()
        {
            base.Clear();
        ...
        public override Event_ERP CheckIntegrity()
        {
            CheckUniqueId();
        ...
        public virtual Event_ERP ClearChildren()
        {
            return this;
        }

        public virtual Event_ERP NewChildren()
        {
            return this;
        }

        public virtual void CopyChildrenFrom(Event_ERP data)
        {
