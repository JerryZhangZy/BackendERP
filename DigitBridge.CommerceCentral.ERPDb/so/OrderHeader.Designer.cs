...
namespace DigitBridge.CommerceCentral.ERPDb
{
    ...
    public partial class OrderHeader : TableRepository<OrderHeader, long>
    {
		...
		public IList<OrderHeader> FindByCustomerUuid(string customerUuid)
		{
			return dbFactory.Find<OrderHeader>("WHERE CustomerUuid = @0 ", customerUuid).ToList();
		}
		public long CountByCustomerUuid(string customerUuid)
		{
			return dbFactory.Count<OrderHeader>("WHERE CustomerUuid = @0 ", customerUuid);
		}
		public async Task<IList<OrderHeader>> FindByAsyncCustomerUuid(string customerUuid)
		{
			return (await dbFactory.FindAsync<OrderHeader>("WHERE CustomerUuid = @0 ", customerUuid)).ToList();
		}
		public async Task<long> CountByAsyncCustomerUuid(string customerUuid)
		{
			return await dbFactory.CountAsync<OrderHeader>("WHERE CustomerUuid = @0 ", customerUuid);
		}
