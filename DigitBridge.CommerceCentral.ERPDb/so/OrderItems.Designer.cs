...
namespace DigitBridge.CommerceCentral.ERPDb
{
    ...
    public partial class OrderItems : TableRepository<OrderItems, long>
    {
        ...
        [Column("OrderItemType",SqlDbType.Int,IsDefault=true)]
        private int? _orderItemType;

        [Column("OrderItemStatus",SqlDbType.Int,IsDefault=true)]
        ...
        public virtual int? OrderItemType
        {
            get
            {
				if (!AllowNull && _orderItemType is null) 
        ...
        public virtual int? OrderItemStatus
        {
            get
            {
				if (!AllowNull && _orderItemStatus is null) 
		...
		public OrderItemsAttributes SetChildrenOrderItemsAttributes(IEnumerable<OrderItemsAttributes> children)
		{
		...
		public IEnumerable<OrderItemsAttributes> GetChildrenOrderItemsAttributes()
		{
        ...
        public override OrderItems Clear()
        {
			...
			_seq = default(int); 
			_orderItemType = AllowNull ? (int?)null : default(int); 
			_orderItemStatus = AllowNull ? (int?)null : default(int); 
		...
		public IEnumerable<OrderItems> FindByOrderUuid(string orderUuid)
		{
			return dbFactory.Find<OrderItems>("WHERE OrderUuid = @0 ORDER BY Seq ", orderUuid);
		}
		public long CountByOrderUuid(string orderUuid)
		{
			return dbFactory.Count<OrderItems>("WHERE OrderUuid = @0 ", orderUuid);
		}
		public async Task<IEnumerable<OrderItems>> FindByAsyncOrderUuid(string orderUuid)
		{
			return await dbFactory.FindAsync<OrderItems>("WHERE OrderUuid = @0 ORDER BY Seq ", orderUuid);
		}
