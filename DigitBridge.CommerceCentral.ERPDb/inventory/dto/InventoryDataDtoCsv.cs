...
{
    /// <summary>
    /// Represents a InventoryDataDtoCsv Class.
    ...
    public partial class InventoryDataDtoCsv : CsvHelper<InventoryDataDto>
    {
        ...
        public override void RegisterMapper(CsvContext context)
        {
            ...
            context.RegisterClassMap(new CsvAutoMapper<InventoryDto>(1));
            context.RegisterClassMap(new CsvAutoMapper<InventoryAttributesDto>(1));
        }
