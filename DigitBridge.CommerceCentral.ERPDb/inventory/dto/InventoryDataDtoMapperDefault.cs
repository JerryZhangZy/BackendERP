...
namespace DigitBridge.CommerceCentral.ERPDb
{
    ...
    public class InventoryDataDtoMapperDefault : IDtoMapper<InventoryData, InventoryDataDto> 
    {
		...
		protected virtual void ReadProductExt(ProductExt data, ProductExtDto dto)
		{
			...
			if (dto.HasDefaultWarehouseNum) data.DefaultWarehouseNum = dto.DefaultWarehouseNum;
			if (dto.HasDefaultVendorNum) data.DefaultVendorNum = dto.DefaultVendorNum;
		...
		protected virtual void ReadInventory(Inventory data, InventoryDto dto)
		{
			...
			if (dto.HasStyleCode) data.StyleCode = dto.StyleCode;
			if (dto.HasColor) data.Color = dto.Color;
			if (dto.HasSizeType) data.SizeType = dto.SizeType;
			if (dto.HasSizeSystem) data.SizeSystem = dto.SizeSystem;
			if (dto.HasSize) data.Size = dto.Size;
			if (dto.HasWidth) data.Width = dto.Width;
			if (dto.HasLength) data.Length = dto.Length;
			if (dto.HasClassCode) data.ClassCode = dto.ClassCode;
			if (dto.HasDepartment) data.Department = dto.Department;
			if (dto.HasDivision) data.Division = dto.Division;
			if (dto.HasYear) data.Year = dto.Year;
			if (dto.HasPriceRule) data.PriceRule = dto.PriceRule;
			if (dto.HasLeadTimeDay) data.LeadTimeDay = dto.LeadTimeDay.ToInt();
			if (dto.HasOrderSize) data.OrderSize = dto.OrderSize.ToDecimal();
			if (dto.HasMinStock) data.MinStock = dto.MinStock.ToDecimal();
			if (dto.HasSKU) data.SKU = dto.SKU;
			if (dto.HasDescription) data.Description = dto.Description;
			if (dto.HasWarehouseUuid) data.WarehouseUuid = dto.WarehouseUuid;
			if (dto.HasWarehouseNum) data.WarehouseNum = dto.WarehouseNum;
		...
		protected virtual void WriteProductExt(ProductExt data, ProductExtDto dto)
		{
			...
			dto.DefaultWarehouseNum = data.DefaultWarehouseNum;
			dto.DefaultVendorNum = data.DefaultVendorNum;
		...
		protected virtual void WriteInventory(Inventory data, InventoryDto dto)
		{
			...
			dto.SizeType = data.SizeType;
			dto.SizeSystem = data.SizeSystem;
			dto.Size = data.Size;
			dto.Width = data.Width;
			dto.Length = data.Length;
			dto.ClassCode = data.ClassCode;
			dto.Department = data.Department;
			dto.Division = data.Division;
			dto.Year = data.Year;
			dto.PriceRule = data.PriceRule;
			dto.LeadTimeDay = data.LeadTimeDay;
			dto.OrderSize = data.OrderSize;
			dto.MinStock = data.MinStock;
			dto.SKU = data.SKU;
			dto.Description = data.Description;
			dto.WarehouseUuid = data.WarehouseUuid;
			dto.WarehouseNum = data.WarehouseNum;
