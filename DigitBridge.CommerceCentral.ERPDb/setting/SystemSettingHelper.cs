...
{
    /// <summary>
    /// Represents a SystemSetting SQL Helper Static Class.
    ...
    {
        public static readonly string TableName = "SystemSetting";
        public static readonly string TableAllies = "ss";
        ...
        public static string SystemSettingUuid(string tableAllies = null, string name = null, bool camelCase = true) => $"RTRIM({tableAllies ?? TableAllies}.SystemSettingUuid) AS {name ?? "SystemSettingUuid".ToCamelCase(camelCase)} ";
...
RTRIM({allies}SystemSettingUuid) AS SystemSettingUuid,
