...
namespace DigitBridge.CommerceCentral.ERPDb
{
    ...
    [UniqueId("SystemSettingUuid")]
    [DtoName("SystemSettingDto")]
    public partial class SystemSetting : TableRepository<SystemSetting, long>
    {

        public SystemSetting() : base() {}
        public SystemSetting(IDataBaseFactory dbFactory): base(dbFactory) {}
        ...
        [Column("SystemSettingUuid",SqlDbType.VarChar,NotNull=true,IsDefault=true)]
        private string _systemSettingUuid;
		...
		[IgnoreCompare] 
		public override string UniqueId => SystemSettingUuid; 
		public override void CheckUniqueId() 
		{
			if (string.IsNullOrEmpty(SystemSettingUuid)) 
		...
		/// </summary>
        public virtual string SystemSettingUuid
        {
            get
            {
				return _systemSettingUuid?.TrimEnd(); 
            }
            set
            {
				_systemSettingUuid = value.TruncateTo(50); 
				OnPropertyChanged("SystemSettingUuid", value);
            }
        }
        ...
        public virtual CustomAttributes Fields
        {
            ...
            {
				if (_Fields is null) 
					_Fields = new CustomAttributes(dbFactory, "SystemSetting"); 
				return _Fields; 
            }
            set
            {
				_Fields = (value is null) ? new CustomAttributes(dbFactory, "SystemSetting") : value; 
            }
        }
		...
		[JsonIgnore, XmlIgnore, IgnoreCompare]
		private SystemSettingData Parent { get; set; }
		public SystemSettingData GetParent() => Parent;
		public SystemSetting SetParent(SystemSettingData parent)
		{
			Parent = parent;
			return this;
		}
        ...
        public override SystemSetting Clear()
        {
            base.Clear();
			_databaseNum = default(int); 
			_masterAccountNum = default(int); 
			_profileNum = default(int); 
			_systemSettingUuid = String.Empty; 
        ...
        public override SystemSetting CheckIntegrity()
        {
            CheckUniqueId();
        ...
        public virtual SystemSetting ClearChildren()
        {
            return this;
        }

        public virtual SystemSetting NewChildren()
        {
            return this;
        }

        public virtual void CopyChildrenFrom(SystemSetting data)
        {
