...
namespace DigitBridge.CommerceCentral.ERPDb
{
    ...
    public class OrderShipmentDataDtoMapperDefault : IDtoMapper<OrderShipmentData, OrderShipmentDataDto>
    {
        ...
        protected virtual void ReadOrderShipmentHeader(OrderShipmentHeader data, OrderShipmentHeaderDto dto)
        {
            ...
            if (dto.HasShipmentDateUtc) data.ShipmentDateUtc = dto.ShipmentDateUtc.ToDateTime();
        ...
        protected virtual void ReadOrderShipmentPackage(OrderShipmentPackage data, OrderShipmentPackageDto dto)
        {
            ...
            if (dto.HasPackageType) data.PackageType = dto.PackageType.ToInt();
            if (dto.HasPackagePatternNum) data.PackagePatternNum = dto.PackagePatternNum.ToInt();
            ...
            if (dto.HasPackageWeight) data.PackageWeight = dto.PackageWeight.ToDecimal();
            if (dto.HasPackageLength) data.PackageLength = dto.PackageLength.ToDecimal();
            if (dto.HasPackageWidth) data.PackageWidth = dto.PackageWidth.ToDecimal();
            if (dto.HasPackageHeight) data.PackageHeight = dto.PackageHeight.ToDecimal();
            if (dto.HasPackageVolume) data.PackageVolume = dto.PackageVolume.ToDecimal();
            if (dto.HasPackageQty) data.PackageQty = dto.PackageQty.ToDecimal();
            if (dto.HasParentPackageNum) data.ParentPackageNum = dto.ParentPackageNum.ToLong();
            ...
            if (dto.OrderShipmentShippedItem != null)
            {
                if (data.OrderShipmentShippedItem is null)
                    data.OrderShipmentShippedItem = new List<OrderShipmentShippedItem>();
                var deleted = ReadOrderShipmentShippedItem(data.OrderShipmentShippedItem, dto.OrderShipmentShippedItem);
                data.SetOrderShipmentShippedItemDeleted(deleted);
            }
        ...
        protected virtual IList<OrderShipmentShippedItem> ReadOrderShipmentShippedItem(IList<OrderShipmentShippedItem> data, IList<OrderShipmentShippedItemDto> dto)
        {
            ...
            foreach (var itemDto in dto)
            {
                ...
                var obj = itemDto.RowNum > 0
                    ...
                    : lstOrig.FirstOrDefault(x => x.OrderShipmentShippedItemUuid == itemDto.OrderShipmentShippedItemUuid);
                if (obj is null)
