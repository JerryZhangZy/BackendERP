...
namespace DigitBridge.CommerceCentral.ERPDb
{
    ...
    /// </summary>
    [Serializable()]
    public partial class ApTransactionDataDtoCsv : CsvHelper<ApTransactionDataDto>
    {
        ...
        {
			context.RegisterClassMap(new CsvAutoMapper<ApInvoiceTransactionDto>());
        }
            ...
            while (csv.Read())
            {
                ...
                switch (csv.GetField(0))
                {
                    case "H":
                        if (!isFirst)
                        {
                            if (dto != null && dto.HasApInvoiceTransaction)
                                data.Add(dto);
