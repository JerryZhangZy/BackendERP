...
namespace DigitBridge.CommerceCentral.ERPDb
{
    ...
    /// </summary>
    public static class BusinessTypeDataDtoExtension
    {
        /// <summary>
        /// Merge BusinessTypeDataDto header objects to one dynamic object
        /// </summary>
        /// <param name="dto">BusinessTypeDataDto object to merge data</param>
        ...
        public static IEnumerable<dynamic> MergeHeaderRecord(this BusinessTypeDataDto dto, bool withHeaderText = false)
        {
            var result = new List<dynamic>();
            if(!dto.HasBusinessType)
                return result;
        ...
        public static IEnumerable<dynamic> MergeDetailRecord(this BusinessTypeDataDto dto, bool withHeaderText = false)
        {
            return null;
            //TODO change to merge Dto children object
            //var result = new List<dynamic>();
        ...
        public static IList<BusinessTypeDataDto> GetFakerData(this BusinessTypeDataDto dto, int count)
        {
            var obj = new BusinessTypeDataDto();
            var datas = new List<BusinessTypeDataDto>();
        ...
        public static BusinessTypeDataDto GetFakerData(this BusinessTypeDataDto dto)
        {
            var data = new BusinessTypeDataDto();
			data.BusinessType = new BusinessTypeDto().GetFaker().Generate();
            return data;
        }


		/// <summary>
		/// Get faker object for BusinessTypeDto
		/// </summary>
		/// <param name="dto">BusinessTypeDto</param>
		/// <returns>Faker object use to generate data</returns>
		public static Faker<BusinessTypeDto> GetFaker(this BusinessTypeDto dto)
		{
			#region faker data rules
			return new Faker<BusinessTypeDto>()
				.RuleFor(u => u.DatabaseNum, f => null)
				.RuleFor(u => u.MasterAccountNum, f => null)
				.RuleFor(u => u.ProfileNum, f => null)
				.RuleFor(u => u.BusinessTypeUuid, f => String.Empty)
