...
{
    /// <summary>
    /// Represents a ShippingCodes Dto Class.
    /// NOTE: This class is generated from a T4 template Once - if you want re-generate it, you need delete cs file and generate again
    /// </summary>
    [Serializable()]
    public class ShippingCodesDto
    {
        ...
        [StringLength(50, ErrorMessage = "The ShippingCodesUuid value cannot exceed 50 characters. ")]
        public string ShippingCodesUuid { get; set; }
        [JsonIgnore, XmlIgnore, IgnoreCompare]
        [OpenApiSchemaVisibility(OpenApiVisibilityType.Internal)]
        public bool HasShippingCodesUuid => ShippingCodesUuid != null;

		/// <summary>
		/// Code type, for example: class, department, style
		/// </summary>
		[OpenApiPropertyDescription("Code type, for example: class, department, style")]
        [StringLength(50, ErrorMessage = "The ShippingCode value cannot exceed 50 characters. ")]
        public string ShippingCode { get; set; }
        [JsonIgnore, XmlIgnore, IgnoreCompare]
        [OpenApiSchemaVisibility(OpenApiVisibilityType.Internal)]
        public bool HasShippingCode => ShippingCode != null;
		...
		/// </summary>
		[OpenApiPropertyDescription("Standard Carrier Alpha Codes. <br> Title: SCAC: Display: true, Editable: true")]
        [StringLength(50, ErrorMessage = "The Scac value cannot exceed 50 characters. ")]
        public string Scac { get; set; }
        [JsonIgnore, XmlIgnore, IgnoreCompare]
        [OpenApiSchemaVisibility(OpenApiVisibilityType.Internal)]
        public bool HasScac => Scac != null;
