...
{
    /// <summary>
    /// Represents a BusinessType Dto Class.
    ...
    public class BusinessTypeDto
    {
        ...
        [StringLength(50, ErrorMessage = "The BusinessTypeUuid value cannot exceed 50 characters. ")]
        public string BusinessTypeUuid { get; set; }
        [JsonIgnore, XmlIgnore, IgnoreCompare]
        [OpenApiSchemaVisibility(OpenApiVisibilityType.Internal)]
        public bool HasBusinessTypeUuid => BusinessTypeUuid != null;

		/// <summary>
		/// Business type code. <br> Title: Paid By, Display: true, Editable: true
		/// </summary>
		[OpenApiPropertyDescription("Business type code. <br> Title: Paid By, Display: true, Editable: true")]
