...
{
    /// <summary>
    /// Represents a SystemCodes Dto Class.
    /// NOTE: This class is generated from a T4 template Once - if you want re-generate it, you need delete cs file and generate again
    /// </summary>
    [Serializable()]
    public class SystemCodesDto
    {
        ...
        [StringLength(50, ErrorMessage = "The SystemCodeUuid value cannot exceed 50 characters. ")]
        public string SystemCodeUuid { get; set; }
        [JsonIgnore, XmlIgnore, IgnoreCompare]
        [OpenApiSchemaVisibility(OpenApiVisibilityType.Internal)]
        public bool HasSystemCodeUuid => SystemCodeUuid != null;

		/// <summary>
		/// Code type, for example: class, department, style
		/// </summary>
		[OpenApiPropertyDescription("Code type, for example: class, department, style")]
        [StringLength(50, ErrorMessage = "The SystemCodeName value cannot exceed 50 characters. ")]
        public string SystemCodeName { get; set; }
        [JsonIgnore, XmlIgnore, IgnoreCompare]
        [OpenApiSchemaVisibility(OpenApiVisibilityType.Internal)]
        public bool HasSystemCodeName => SystemCodeName != null;
		...
		/// Disable this Code
		/// </summary>
		[OpenApiPropertyDescription("Disable this Code")]
        ...
        [JsonIgnore, XmlIgnore, IgnoreCompare]
        [OpenApiSchemaVisibility(OpenApiVisibilityType.Internal)]
        public bool HasEffectiveStart => EffectiveStart != null;
        ...
        [JsonIgnore, XmlIgnore, IgnoreCompare]
        [OpenApiSchemaVisibility(OpenApiVisibilityType.Internal)]
        public bool HasEffectiveEnd => EffectiveEnd != null;
