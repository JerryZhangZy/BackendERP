...
{
    /// <summary>
    /// Represents a BusinessTypeDataDtoCsv Class.
    /// NOTE: This class is generated from a T4 template Once - you you wanr re-generate it, you need delete cs file and generate again
    /// </summary>
    [Serializable()]
    public partial class BusinessTypeDataDtoCsv : CsvHelper<BusinessTypeDataDto>
    {
        ...
        {
			context.RegisterClassMap(new CsvAutoMapper<BusinessTypeDto>());
        }
        
        protected override void WriteCsv(BusinessTypeDataDto data, CsvWriter csv)
        {
        ...
        public override void ReadEntities(CsvReader csv, IList<BusinessTypeDataDto> data)
        {
            var isFirst = true;
            BusinessTypeDataDto dto = new BusinessTypeDataDto();
            while (csv.Read())
            {
                // it is header line
                ...
                switch (csv.GetField(0))
                {
                    case "H":
                        if (!isFirst)
                        {
                            if (dto != null && dto.HasBusinessType)
                                data.Add(dto);
