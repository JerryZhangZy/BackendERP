...
namespace DigitBridge.CommerceCentral.ERPDb
{
    ...
    /// </summary>
    public static class CustomIOFormatDataDtoExtension
    {
        /// <summary>
        /// Merge CustomIOFormatDataDto header objects to one dynamic object
        /// </summary>
        /// <param name="dto">CustomIOFormatDataDto object to merge data</param>
        ...
        public static IEnumerable<dynamic> MergeHeaderRecord(this CustomIOFormatDataDto dto, bool withHeaderText = false)
        {
            var result = new List<dynamic>();
            if(!dto.HasCustomIOFormat)
                return result;
        ...
        public static IEnumerable<dynamic> MergeDetailRecord(this CustomIOFormatDataDto dto, bool withHeaderText = false)
        {
            return null;
            //TODO change to merge Dto children object
            //var result = new List<dynamic>();
        ...
        public static IList<CustomIOFormatDataDto> GetFakerData(this CustomIOFormatDataDto dto, int count)
        {
            var obj = new CustomIOFormatDataDto();
            var datas = new List<CustomIOFormatDataDto>();
		...
		/// <summary>
		/// Get faker object for CustomIOFormatDto
		/// </summary>
		/// <param name="dto">CustomIOFormatDto</param>
		/// <returns>Faker object use to generate data</returns>
		public static Faker<CustomIOFormatDto> GetFaker(this CustomIOFormatDto dto)
		{
			#region faker data rules
			return new Faker<CustomIOFormatDto>()
				.RuleFor(u => u.DatabaseNum, f => null)
				.RuleFor(u => u.MasterAccountNum, f => null)
				.RuleFor(u => u.ProfileNum, f => null)
				.RuleFor(u => u.CustomIOFormatUuid, f => String.Empty)
