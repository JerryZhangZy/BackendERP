...
{
    /// <summary>
    /// Represents a PaidbyMapDataDtoCsv Class.
    /// NOTE: This class is generated from a T4 template Once - you you wanr re-generate it, you need delete cs file and generate again
    /// </summary>
    [Serializable()]
    public partial class PaidbyMapDataDtoCsv : CsvHelper<PaidbyMapDataDto>
    {
        ...
        {
			context.RegisterClassMap(new CsvAutoMapper<PaidbyMapDto>());
        }
        
        protected override void WriteCsv(PaidbyMapDataDto data, CsvWriter csv)
        {
        ...
        public override void ReadEntities(CsvReader csv, IList<PaidbyMapDataDto> data)
        {
            var isFirst = true;
            PaidbyMapDataDto dto = new PaidbyMapDataDto();
            while (csv.Read())
            {
                // it is header line
