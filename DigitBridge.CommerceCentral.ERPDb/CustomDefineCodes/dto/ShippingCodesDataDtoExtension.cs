...
{
    /// <summary>
    /// Represents a ShippingCodesDataDtoMapperDefault Class.
    /// NOTE: This class is generated from a T4 template Once - you you wanr re-generate it, you need delete cs file and generate again
    /// </summary>
    public static class ShippingCodesDataDtoExtension
    {
        /// <summary>
        /// Merge ShippingCodesDataDto header objects to one dynamic object
        /// </summary>
        /// <param name="dto">ShippingCodesDataDto object to merge data</param>
        ...
        public static IEnumerable<dynamic> MergeHeaderRecord(this ShippingCodesDataDto dto, bool withHeaderText = false)
        {
            var result = new List<dynamic>();
            if(!dto.HasShippingCodes)
                return result;
        ...
        public static IEnumerable<dynamic> MergeDetailRecord(this ShippingCodesDataDto dto, bool withHeaderText = false)
        {
            return null;
            //TODO change to merge Dto children object
            //var result = new List<dynamic>();
        ...
        public static IList<ShippingCodesDataDto> GetFakerData(this ShippingCodesDataDto dto, int count)
        {
            var obj = new ShippingCodesDataDto();
            var datas = new List<ShippingCodesDataDto>();
        ...
        public static ShippingCodesDataDto GetFakerData(this ShippingCodesDataDto dto)
        {
            var data = new ShippingCodesDataDto();
			data.ShippingCodes = new ShippingCodesDto().GetFaker().Generate();
            return data;
        }


		/// <summary>
		/// Get faker object for ShippingCodesDto
		/// </summary>
		/// <param name="dto">ShippingCodesDto</param>
		/// <returns>Faker object use to generate data</returns>
		public static Faker<ShippingCodesDto> GetFaker(this ShippingCodesDto dto)
		{
			#region faker data rules
			return new Faker<ShippingCodesDto>()
				.RuleFor(u => u.DatabaseNum, f => null)
				.RuleFor(u => u.MasterAccountNum, f => null)
				.RuleFor(u => u.ProfileNum, f => null)
				.RuleFor(u => u.ShippingCodesUuid, f => String.Empty)
