...
{
    /// <summary>
    /// Represents a SystemCodes SQL Helper Static Class.
    /// NOTE: This class is generated from a T4 template Once - you want re-generate it, you need delete cs file and generate again
    /// </summary>
    public static class SystemCodesHelper
    {
        public static readonly string TableName = "SystemCodes";
        public static readonly string TableAllies = "sc";
        ...
        public static string SystemCodeUuid(string tableAllies = null, string name = null, bool camelCase = true) => $"RTRIM({tableAllies ?? TableAllies}.SystemCodeUuid) AS {name ?? "SystemCodeUuid".ToCamelCase(camelCase)} ";
        public static string SystemCodeName(string tableAllies = null, string name = null, bool camelCase = true) => $"RTRIM({tableAllies ?? TableAllies}.SystemCodeName) AS {name ?? "SystemCodeName".ToCamelCase(camelCase)} ";
        ...
        public static string EffectiveStart(string tableAllies = null, string name = null, bool camelCase = true) => $"{tableAllies ?? TableAllies}.EffectiveStart AS {name ?? "EffectiveStart".ToCamelCase(camelCase)} ";
        public static string EffectiveEnd(string tableAllies = null, string name = null, bool camelCase = true) => $"{tableAllies ?? TableAllies}.EffectiveEnd AS {name ?? "EffectiveEnd".ToCamelCase(camelCase)} ";
...
RTRIM({allies}SystemCodeUuid) AS SystemCodeUuid,
RTRIM({allies}SystemCodeName) AS SystemCodeName,
RTRIM({allies}Description) AS Description,
{allies}InActive AS InActive,
{allies}EffectiveStart AS EffectiveStart,
{allies}EffectiveEnd AS EffectiveEnd,
