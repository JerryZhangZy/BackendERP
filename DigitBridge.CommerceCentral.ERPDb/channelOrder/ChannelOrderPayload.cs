...
namespace DigitBridge.CommerceCentral.ERPDb
{
    ...
    public class ChannelOrderPayload : PayloadBase
    {
        ...
        public override IDictionary<string, Action<string>> GetOtherParameters()
        {
            ...
            {
                { "CentralOrderUuids", val => CentralOrderUuids = val.Split(",").ToList() }
            };
        }
        ...
        /// <summary>
        /// (Request Parameter) Array of uuid to load multiple ChannelOrder dto data.
        /// </summary>
        [OpenApiPropertyDescription("(Request Parameter) Array of uuid to load multiple ChannelOrder dto data.")]
