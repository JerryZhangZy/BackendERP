...
namespace DigitBridge.CommerceCentral.ERPDb
{
    ...
    public static class InvoiceItemsHelper
    {
        ...
        public static string InvoiceItemType(string tableAllies = null, string name = null) => $"{tableAllies ?? TableAllies}.InvoiceItemType AS {name ?? "InvoiceItemType"} ";
        public static string InvoiceItemStatus(string tableAllies = null, string name = null) => $"{tableAllies ?? TableAllies}.InvoiceItemStatus AS {name ?? "InvoiceItemStatus"} ";
        ...
        public static string OrderAmount(string tableAllies = null, string name = null) => $"{tableAllies ?? TableAllies}.OrderAmount AS {name ?? "OrderAmount"} ";
