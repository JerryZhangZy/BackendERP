    ...
    public partial class InvoiceIOFormat : CsvFormat
    {
		...
		protected virtual void InitInvoiceHeader()
		{
			...
			obj.Columns = new List<CsvFormatColumn>()
			{
				...
				new CsvFormatColumn("InvoiceStatus", "", idx++, null, false),
				new CsvFormatColumn("InvoiceDate", "", idx++, FormatType.Date, false),
				new CsvFormatColumn("InvoiceTime", "", idx++, FormatType.Time, false),
		...
		protected virtual void InitInvoiceItems()
		{
			...
			obj.Columns = new List<CsvFormatColumn>()
			{
				...
				new CsvFormatColumn("OrderShipmentShippedItemNum", "", idx++, null, false),
			};
		}
