...
{
    /// <summary>
    /// Represents a InvoiceHeaderInfo Dto Class.
    ...
    public class InvoiceHeaderInfoDto
    {
		...
		/// </summary>
		[OpenApiPropertyDescription("(Readonly) Reference to Shipment number. <br> Display: true, Editable: false")]
		...
		/// </summary>
		[OpenApiPropertyDescription("(Readonly) Reference to Shipment uuid. <br> Display: false, Editable: false")]
