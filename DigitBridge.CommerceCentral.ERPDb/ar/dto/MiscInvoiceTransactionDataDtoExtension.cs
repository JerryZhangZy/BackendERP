...
namespace DigitBridge.CommerceCentral.ERPDb
{
    ...
    /// </summary>
    public static class MiscInvoiceTransactionDataDtoExtension
    {
        /// <summary>
        /// Merge MiscInvoiceTransactionDataDto header objects to one dynamic object
        /// </summary>
        /// <param name="dto">MiscInvoiceTransactionDataDto object to merge data</param>
        ...
        public static IEnumerable<dynamic> MergeHeaderRecord(this MiscInvoiceTransactionDataDto dto, bool withHeaderText = false)
        {
            var result = new List<dynamic>();
            if(!dto.HasMiscInvoiceTransaction)
                return result;
        ...
        public static IEnumerable<dynamic> MergeDetailRecord(this MiscInvoiceTransactionDataDto dto, bool withHeaderText = false)
        {
            return null;
            //TODO change to merge Dto children object
            //var result = new List<dynamic>();
        ...
        public static IList<MiscInvoiceTransactionDataDto> GetFakerData(this MiscInvoiceTransactionDataDto dto, int count)
        {
            var obj = new MiscInvoiceTransactionDataDto();
            var datas = new List<MiscInvoiceTransactionDataDto>();
        ...
        public static MiscInvoiceTransactionDataDto GetFakerData(this MiscInvoiceTransactionDataDto dto)
        {
            var data = new MiscInvoiceTransactionDataDto();
			data.MiscInvoiceTransaction = new MiscInvoiceTransactionDto().GetFaker().Generate();
            return data;
        }
