...
{
    /// <summary>
    /// Represents a MiscInvoiceTransactionDataDtoCsv Class.
    /// NOTE: This class is generated from a T4 template Once - you you wanr re-generate it, you need delete cs file and generate again
    /// </summary>
    [Serializable()]
    public partial class MiscInvoiceTransactionDataDtoCsv : CsvHelper<MiscInvoiceTransactionDataDto>
    {
        ...
        protected override void WriteCsv(MiscInvoiceTransactionDataDto data, CsvWriter csv)
        {
        ...
        public override void ReadEntities(CsvReader csv, IList<MiscInvoiceTransactionDataDto> data)
        {
            var isFirst = true;
            MiscInvoiceTransactionDataDto dto = new MiscInvoiceTransactionDataDto();
            while (csv.Read())
            {
                // it is header line
                ...
                switch (csv.GetField(0))
                {
                    case "H":
                        if (!isFirst)
                        {
                            if (dto != null && dto.HasMiscInvoiceTransaction)
                                data.Add(dto);
                            dto = new MiscInvoiceTransactionDataDto();
                            isFirst = false;
                        }
                        dto. MiscInvoiceTransaction = csv.GetRecord<MiscInvoiceTransactionDto>();
                        break;
                    //case "L":
