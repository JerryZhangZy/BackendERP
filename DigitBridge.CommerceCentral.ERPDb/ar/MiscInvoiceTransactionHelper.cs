...
{
    /// <summary>
    /// Represents a MiscInvoiceTransaction SQL Helper Static Class.
    /// NOTE: This class is generated from a T4 template Once - you want re-generate it, you need delete cs file and generate again
    /// </summary>
    public static class MiscInvoiceTransactionHelper
    {
        public static readonly string TableName = "MiscInvoiceTransaction";
        public static readonly string TableAllies = "minsl";
