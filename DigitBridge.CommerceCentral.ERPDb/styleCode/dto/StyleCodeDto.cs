...
{
    /// <summary>
    /// Represents a StyleCode Dto Class.
    /// NOTE: This class is generated from a T4 template Once - if you want re-generate it, you need delete cs file and generate again
    /// </summary>
    [Serializable()]
    public class StyleCodeDto
    {
		...
		/// <summary>
		/// (Readonly) Product StyleCode uuid. load from ProductBasic data. <br> Display: false, Editable: false
		/// </summary>
		[OpenApiPropertyDescription("(Readonly) Product StyleCode uuid. load from ProductBasic data. <br> Display: false, Editable: false")]
        [StringLength(50, ErrorMessage = "The StyleCodeUuid value cannot exceed 50 characters. ")]
        public string StyleCodeUuid { get; set; }
        [JsonIgnore, XmlIgnore, IgnoreCompare]
        [OpenApiSchemaVisibility(OpenApiVisibilityType.Internal)]
        public bool HasStyleCodeUuid => StyleCodeUuid != null;
        ...
        [StringLength(100, ErrorMessage = "The ProductStyleCode value cannot exceed 100 characters. ")]
        public string ProductStyleCode { get; set; }
        [JsonIgnore, XmlIgnore, IgnoreCompare]
        [OpenApiSchemaVisibility(OpenApiVisibilityType.Internal)]
        public bool HasProductStyleCode => ProductStyleCode != null;

		/// <summary>
		/// Product Default VariationSet. <br> Title: Variation Set, Display: true, Editable: true
		/// </summary>
		[OpenApiPropertyDescription("Product Default VariationSet. <br> Title: Variation Set, Display: true, Editable: true")]
        [StringLength(50, ErrorMessage = "The VariationSet value cannot exceed 50 characters. ")]
        public string VariationSet { get; set; }
        [JsonIgnore, XmlIgnore, IgnoreCompare]
        [OpenApiSchemaVisibility(OpenApiVisibilityType.Internal)]
        public bool HasVariationSet => VariationSet != null;

		/// <summary>
		/// Product Default VariationSetUuid. <br> Display: false, Editable: false
		/// </summary>
		[OpenApiPropertyDescription("Product Default VariationSetUuid. <br> Display: false, Editable: false")]
        [StringLength(50, ErrorMessage = "The VariationSetUuid value cannot exceed 50 characters. ")]
        public string VariationSetUuid { get; set; }
        [JsonIgnore, XmlIgnore, IgnoreCompare]
        [OpenApiSchemaVisibility(OpenApiVisibilityType.Internal)]
        public bool HasVariationSetUuid => VariationSetUuid != null;

		/// <summary>
		/// Product included color and pattern codes. <br> Title: Colors, Display: true, Editable: true
		/// </summary>
		[OpenApiPropertyDescription("Product included color and pattern codes. <br> Title: Colors, Display: true, Editable: true")]
        [StringLength(2000, ErrorMessage = "The ColorPatternCode value cannot exceed 2000 characters. ")]
		...
		/// <summary>
		/// Product included size types. <br> Title: Size Type, Display: true, Editable: true
		/// </summary>
		[OpenApiPropertyDescription("Product included size types. <br> Title: Size Type, Display: true, Editable: true")]
        [StringLength(1000, ErrorMessage = "The SizeType value cannot exceed 1000 characters. ")]
		...
		/// <summary>
		/// Product included size codes. <br> Title: Size, Display: true, Editable: true
		/// </summary>
		[OpenApiPropertyDescription("Product included size codes. <br> Title: Size, Display: true, Editable: true")]
        [StringLength(1000, ErrorMessage = "The SizeCode value cannot exceed 1000 characters. ")]
		...
		/// <summary>
		/// Product included width codes. <br> Title: Width, Display: true, Editable: true
		/// </summary>
		[OpenApiPropertyDescription("Product included width codes. <br> Title: Width, Display: true, Editable: true")]
        [StringLength(1000, ErrorMessage = "The WidthCode value cannot exceed 1000 characters. ")]
		...
		/// <summary>
		/// Product included length codes. <br> Title: Length, Display: true, Editable: true
		/// </summary>
		[OpenApiPropertyDescription("Product included length codes. <br> Title: Length, Display: true, Editable: true")]
        [StringLength(1000, ErrorMessage = "The LengthCode value cannot exceed 1000 characters. ")]
		...
		/// <summary>
		/// SKU Prefix. <br> Title: SKU, Display: true, Editable: true
		/// </summary>
		[OpenApiPropertyDescription("SKU Prefix. <br> Title: SKU, Display: true, Editable: true")]
		...
		/// <summary>
		/// Status. <br> Title: Status, Display: true, Editable: true
		/// </summary>
		[OpenApiPropertyDescription("Status. <br> Title: Status, Display: true, Editable: true")]
        public int? StyleStatus { get; set; }
        [JsonIgnore, XmlIgnore, IgnoreCompare]
        [OpenApiSchemaVisibility(OpenApiVisibilityType.Internal)]
        public bool HasStyleStatus => StyleStatus != null;

		/// <summary>
		/// Type. <br> Title: Type, Display: true, Editable: true
		/// </summary>
		[OpenApiPropertyDescription("Type. <br> Title: Type, Display: true, Editable: true")]
        public int? StyleType { get; set; }
        [JsonIgnore, XmlIgnore, IgnoreCompare]
        [OpenApiSchemaVisibility(OpenApiVisibilityType.Internal)]
        public bool HasStyleType => StyleType != null;
		...
		/// <summary>
		/// StyleCode notes. <br> Title: Notes, Display: true, Editable: true
		/// </summary>
		[OpenApiPropertyDescription("StyleCode notes. <br> Title: Notes, Display: true, Editable: true")]
		...
		/// <summary>
		/// (Readonly) Style Code created from other entity number, use to prevent import duplicate order. <br> Title: Source Number, Display: false, Editable: false
		/// </summary>
		[OpenApiPropertyDescription("(Readonly) Style Code created from other entity number, use to prevent import duplicate order. <br> Title: Source Number, Display: false, Editable: false")]
