...
{
    /// <summary>
    /// Represents a StyleCodeDataDtoCsv Class.
    /// NOTE: This class is generated from a T4 template Once - you you wanr re-generate it, you need delete cs file and generate again
    /// </summary>
    [Serializable()]
    public partial class StyleCodeDataDtoCsv : CsvHelper<StyleCodeDataDto>
    {
        ...
        {
			context.RegisterClassMap(new CsvAutoMapper<StyleCodeDto>());
			context.RegisterClassMap(new CsvAutoMapper<StyleCodeAttributesDto>());
        }
        
        protected override void WriteCsv(StyleCodeDataDto data, CsvWriter csv)
        {
        ...
        public override void ReadEntities(CsvReader csv, IList<StyleCodeDataDto> data)
        {
            var isFirst = true;
            StyleCodeDataDto dto = new StyleCodeDataDto();
            while (csv.Read())
            {
                // it is header line
