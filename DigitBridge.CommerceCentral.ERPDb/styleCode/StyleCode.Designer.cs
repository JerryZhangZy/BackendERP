...
namespace DigitBridge.CommerceCentral.ERPDb
{
    ...
    [DtoName("StyleCodeDto")]
    public partial class StyleCode : TableRepository<StyleCode, long>
    {

        public StyleCode() : base() {}
        public StyleCode(IDataBaseFactory dbFactory): base(dbFactory) {}
        ...
        [Column("ProductStyleCode",SqlDbType.VarChar,NotNull=true,IsDefault=true)]
        private string _productStyleCode;

        [Column("VariationSet",SqlDbType.VarChar,NotNull=true,IsDefault=true)]
        private string _variationSet;

        [Column("VariationSetUuid",SqlDbType.VarChar,NotNull=true,IsDefault=true)]
        private string _variationSetUuid;
        ...
        [Column("StyleStatus",SqlDbType.Int,NotNull=true,IsDefault=true)]
        private int _styleStatus;

        [Column("StyleType",SqlDbType.Int,NotNull=true,IsDefault=true)]
		...
		/// </summary>
        public virtual string ProductStyleCode
        {
            get
            {
				return _productStyleCode?.TrimEnd(); 
            }
            set
            {
				_productStyleCode = value.TruncateTo(100); 
				OnPropertyChanged("ProductStyleCode", value);
            }
        }
		...
		/// </summary>
        public virtual string VariationSet
        {
            get
            {
				return _variationSet?.TrimEnd(); 
            }
            set
            {
				_variationSet = value.TruncateTo(50); 
				OnPropertyChanged("VariationSet", value);
            }
        }
		...
		/// </summary>
        public virtual string VariationSetUuid
        {
            get
            {
				return _variationSetUuid?.TrimEnd(); 
            }
            set
            {
				_variationSetUuid = value.TruncateTo(50); 
				OnPropertyChanged("VariationSetUuid", value);
            }
        }
        ...
        public virtual string ColorPatternCode
        {
            ...
            set
            {
				_colorPatternCode = value.TruncateTo(2000); 
        ...
        public virtual string SizeType
        {
            ...
            set
            {
				_sizeType = value.TruncateTo(1000); 
        ...
        public virtual string SizeCode
        {
            ...
            set
            {
				_sizeCode = value.TruncateTo(1000); 
        ...
        public virtual string WidthCode
        {
            ...
            set
            {
				_widthCode = value.TruncateTo(1000); 
        ...
        public virtual string LengthCode
        {
            ...
            set
            {
				_lengthCode = value.TruncateTo(1000); 
		...
		/// </summary>
        public virtual int StyleStatus
        {
            get
            {
				return _styleStatus; 
            ...
            {
				_styleStatus = value; 
				OnPropertyChanged("StyleStatus", value);
            }
        }
        ...
        public virtual int StyleType
        {
            ...
            {
				_styleType = value; 
				OnPropertyChanged("StyleType", value);
            }
        }
		...
		public StyleCode SetParent(StyleCodeData parent)
		{
			Parent = parent;
			return this;
		}
        ...
        public override StyleCode Clear()
        {
            base.Clear();
			...
			_productStyleCode = String.Empty; 
			_variationSet = String.Empty; 
			_variationSetUuid = String.Empty; 
			...
			_sku = String.Empty; 
			_styleStatus = default(int); 
			_styleType = default(int); 
        ...
        public override StyleCode CheckIntegrity()
        {
            CheckUniqueId();
        ...
        public virtual StyleCode ClearChildren()
        {
            return this;
        }

        public virtual StyleCode NewChildren()
        {
            return this;
        }

        public virtual void CopyChildrenFrom(StyleCode data)
        {
		...
		public override StyleCode ConvertDbFieldsToData()
		{
			base.ConvertDbFieldsToData();
			return this;
		}
		public override StyleCode ConvertDataFieldsToDb()
		{
