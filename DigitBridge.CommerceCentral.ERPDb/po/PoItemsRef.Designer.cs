...
{
    /// <summary>
    /// Represents a PoItemsRef.
    /// NOTE: This class is generated from a T4 template - you should not modify it manually.
    /// </summary>
    [Serializable()]
    [ExplicitColumns]
    [TableName("PoItemsRef")]
    [PrimaryKey("RowNum", AutoIncrement = true)]
    [UniqueId("PoItemUuid")]
    [DtoName("PoItemsRefDto")]
    public partial class PoItemsRef : TableRepository<PoItemsRef, long>
    {

        public PoItemsRef() : base() {}
        public PoItemsRef(IDataBaseFactory dbFactory): base(dbFactory) {}
		...
		public PoItemsRef SetParent(PurchaseOrderData parent)
		{
			Parent = parent;
			return this;
		}
        ...
        public override PoItemsRef Clear()
        {
            base.Clear();
        ...
        public override PoItemsRef CheckIntegrity()
        {
            CheckUniqueId();
        ...
        public virtual PoItemsRef ClearChildren()
        {
            return this;
        }

        public virtual PoItemsRef NewChildren()
        {
            return this;
        }

        public virtual void CopyChildrenFrom(PoItemsRef data)
        {
            if (data is null) return;
            return;
        }

		public static IList<PoItemsRef> FindByPoUuid(IDataBaseFactory dbFactory, string poUuid)
		{
			return dbFactory.Find<PoItemsRef>("WHERE PoUuid = @0 ", poUuid).ToList();
		}
		public static long CountByPoUuid(IDataBaseFactory dbFactory, string poUuid)
		{
			return dbFactory.Count<PoItemsRef>("WHERE PoUuid = @0 ", poUuid);
		}
		public static async Task<IList<PoItemsRef>> FindByAsyncPoUuid(IDataBaseFactory dbFactory, string poUuid)
		{
			return (await dbFactory.FindAsync<PoItemsRef>("WHERE PoUuid = @0 ", poUuid)).ToList();
		}
		public static async Task<long> CountByAsyncPoUuid(IDataBaseFactory dbFactory, string poUuid)
		{
			return await dbFactory.CountAsync<PoItemsRef>("WHERE PoUuid = @0 ", poUuid);
		}

		public override PoItemsRef ConvertDbFieldsToData()
		{
			base.ConvertDbFieldsToData();
			return this;
		}
		public override PoItemsRef ConvertDataFieldsToDb()
		{
