...
{
    /// <summary>
    /// Represents a PoHeaderInfo.
    /// NOTE: This class is generated from a T4 template - you should not modify it manually.
    /// </summary>
    [Serializable()]
    [ExplicitColumns]
    [TableName("PoHeaderInfo")]
    [PrimaryKey("RowNum", AutoIncrement = true)]
    [UniqueId("PoUuid")]
    [DtoName("PoHeaderInfoDto")]
    public partial class PoHeaderInfo : TableRepository<PoHeaderInfo, long>
    {

        public PoHeaderInfo() : base() {}
        public PoHeaderInfo(IDataBaseFactory dbFactory): base(dbFactory) {}
		...
		public PoHeaderInfo SetParent(PurchaseOrderData parent)
		{
			Parent = parent;
			return this;
		}
        ...
        public override PoHeaderInfo Clear()
        {
            base.Clear();
        ...
        public override PoHeaderInfo CheckIntegrity()
        {
            CheckUniqueId();
        ...
        public virtual PoHeaderInfo ClearChildren()
        {
            return this;
        }

        public virtual PoHeaderInfo NewChildren()
        {
            return this;
        }

        public virtual void CopyChildrenFrom(PoHeaderInfo data)
        {
		...
		public override PoHeaderInfo ConvertDbFieldsToData()
		{
			base.ConvertDbFieldsToData();
			return this;
		}
		public override PoHeaderInfo ConvertDataFieldsToDb()
		{
