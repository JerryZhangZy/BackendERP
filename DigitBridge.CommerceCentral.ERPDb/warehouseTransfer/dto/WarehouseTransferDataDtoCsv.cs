...
{
    /// <summary>
    /// Represents a WarehouseTransferDataDtoCsv Class.
    /// NOTE: This class is generated from a T4 template Once - you you wanr re-generate it, you need delete cs file and generate again
    /// </summary>
    [Serializable()]
    public partial class WarehouseTransferDataDtoCsv : CsvHelper<WarehouseTransferDataDto>
    {
        ...
        public override void ReadEntities(CsvReader csv, IList<WarehouseTransferDataDto> data)
        {
            var isFirst = true;
            WarehouseTransferDataDto dto = new WarehouseTransferDataDto();
            while (csv.Read())
            {
                // it is header line
                ...
                switch (csv.GetField(0))
                {
                    case "H":
                        if (!isFirst)
                        {
                            if (dto != null && dto.HasWarehouseTransferHeader)
                                data.Add(dto);
