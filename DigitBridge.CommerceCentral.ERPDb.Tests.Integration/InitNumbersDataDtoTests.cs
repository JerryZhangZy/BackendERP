...
namespace DigitBridge.CommerceCentral.ERPDb.Tests.Integration
{
    ...
    /// </summary>
    public partial class InitNumbersDataDtoTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        ...
        public InitNumbersDataDtoTests(TestFixture<StartupTest> fixture) 
        {
            Fixture = fixture;
		...
		{
            var mapper = new InitNumbersDataDtoMapperDefault();

            var data = GetFakerData();
            var dto = mapper.WriteDto(data, null);
            var data2 = new InitNumbersData();
        ...
        public void ExportCsv_Test()
        {
            ...
            //var dto = mapper.WriteDto(data, null);
            var fileName = "c:\\temp\\_InitNumbersDataDto.csv";
            var csvHelper = new InitNumbersDataDtoCsv();
