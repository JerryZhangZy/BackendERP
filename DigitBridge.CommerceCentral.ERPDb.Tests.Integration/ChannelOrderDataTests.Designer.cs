...
{
    /// <summary>
    /// Represents a Tester for ChannelOrderData.
    /// NOTE: This class is generated from a T4 template - you should not modify it manually.
    /// </summary>
    public partial class ChannelOrderDataTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        public static ChannelOrderData GetFakerData()
        {
        ...
        public static List<ChannelOrderData> GetFakerData(int count)
        {
			var ChannelOrderDatas = new List<ChannelOrderData>(); 
			for (int i = 0; i < count; i++) 
				ChannelOrderDatas.Add(GetFakerData()); 
			return ChannelOrderDatas; 
        }
        ...
        public ChannelOrderDataTests(TestFixture<StartupTest> fixture) 
        {
            Fixture = fixture;
...
");
            ...
            var data = new ChannelOrderData(DataBaseFactory);
            data.GetById(id);
...
");
            ...
            var dataGetById = new ChannelOrderData(DataBaseFactory);
