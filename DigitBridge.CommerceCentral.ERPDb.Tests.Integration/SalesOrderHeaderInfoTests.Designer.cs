...
{
    /// <summary>
    /// Represents a Tester for SalesOrderHeaderInfo.
    /// NOTE: This class is generated from a T4 template - you should not modify it manually.
    /// </summary>
    public partial class SalesOrderHeaderInfoTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        public static Faker<SalesOrderHeaderInfo> GetFakerData()
        {
        ...
        public Faker<SalesOrderHeaderInfo> FakerData { get; set; }
        public IDataBaseFactory DataBaseFactory { get; set; }

        public SalesOrderHeaderInfoTests(TestFixture<StartupTest> fixture) 
        {
            Fixture = fixture;
		...
		public void Add_Test()
		{
            ...
            var dataGet = DataBaseFactory.GetFromCacheById<SalesOrderHeaderInfo>(data.UniqueId);
        ...
        {
            var list = DataBaseFactory.Find<SalesOrderHeaderInfo>("SELECT TOP 1 * FROM SalesOrderHeaderInfo").ToList();
        ...
        public void Patch_Test()
        {
            ...
            DataBaseFactory.Begin();
            var data = list.FirstOrDefault();
            var dataOrig = new SalesOrderHeaderInfo();
            ...
            var dataGet = DataBaseFactory.GetFromCache<SalesOrderHeaderInfo>(data.RowNum);
        ...
        public void Save_Test()
        {
            ...
            var dataGet = DataBaseFactory.GetFromCacheById<SalesOrderHeaderInfo>(dataUpdate.UniqueId);
        ...
        { 
            ...
            var result = DataBaseFactory.ExistUniqueId<SalesOrderHeaderInfo>(data.UniqueId);
        ...
        {
            //var list = DataBaseFactory.Find<SalesOrderHeaderInfo>().ToList();
            //var listData = list.FirstOrDefault();
            //var data = DataBaseFactory.Get<SalesOrderHeaderInfo>(listData.RowNum);
        ...
        public void GetById_Test()
        {
            var list = DataBaseFactory.Find<SalesOrderHeaderInfo>("SELECT TOP 1 * FROM SalesOrderHeaderInfo").ToList();
            var listData = list.FirstOrDefault();
            var data = DataBaseFactory.GetById<SalesOrderHeaderInfo>(listData.UniqueId);
            var result = data.Equals(listData);
        ...
        public void GetFromCacheById_Test()
        {
            var list = DataBaseFactory.Find<SalesOrderHeaderInfo>("SELECT TOP 1 * FROM SalesOrderHeaderInfo").ToList();
            var data = list.FirstOrDefault();
            var data1 = DataBaseFactory.GetFromCacheById<SalesOrderHeaderInfo>(data.UniqueId);
            var data2 = DataBaseFactory.GetFromCacheById<SalesOrderHeaderInfo>(data.UniqueId);
        ...
        public async Task AddAsync_Test()
        {
            ...
            var dataGet = await DataBaseFactory.GetFromCacheByIdAsync<SalesOrderHeaderInfo>(data.UniqueId);
            var result = data.Equals(dataGet);
        ...
        {
            var list = (await DataBaseFactory.FindAsync<SalesOrderHeaderInfo>()).ToList();
        ...
        public async Task PatchAsync_Test()
        {
            ...
            var dataGet = await DataBaseFactory.GetFromCacheAsync<SalesOrderHeaderInfo>(data.RowNum);
            var result = dataGet.ShippingCarrier != dataOrig.ShippingCarrier &&
                            dataGet.ShippingClass != dataOrig.ShippingClass &&
                            dataGet.ShippingCarrier == newData.ShippingCarrier &&
                            dataGet.ShippingClass == newData.ShippingClass;
        ...
        public async Task SaveAsync_Test()
        {
            ...
            var dataGet = await DataBaseFactory.GetFromCacheByIdAsync<SalesOrderHeaderInfo>(dataUpdate.UniqueId);
            var result = dataUpdate.Equals(dataGet);
        ...
        public async Task DeleteAsync_Test()
        {
            ...
            var result = await DataBaseFactory.ExistUniqueIdAsync<SalesOrderHeaderInfo>(data.UniqueId);
        ...
        public async Task GetAsync_Test()
        {
            var list = (await DataBaseFactory.FindAsync<SalesOrderHeaderInfo>()).ToList();
            var listData = list.FirstOrDefault();
            var data = await DataBaseFactory.GetAsync<SalesOrderHeaderInfo>(listData.RowNum);
            var result = data.Equals(listData);
        ...
        public async Task GetByIdAsync_Test()
        {
            var list = (await DataBaseFactory.FindAsync<SalesOrderHeaderInfo>()).ToList();
            var listData = list.FirstOrDefault();
            var data = await DataBaseFactory.GetByIdAsync<SalesOrderHeaderInfo>(listData.UniqueId);
            var result = data.Equals(listData);
        ...
        {
            var list = (await DataBaseFactory.FindAsync<SalesOrderHeaderInfo>("SELECT TOP 1 * FROM SalesOrderHeaderInfo")).ToList();
            var data = list.FirstOrDefault();
            var data1 = await DataBaseFactory.GetFromCacheByIdAsync<SalesOrderHeaderInfo>(data.UniqueId);
            var data2 = await DataBaseFactory.GetFromCacheByIdAsync<SalesOrderHeaderInfo>(data.UniqueId);
