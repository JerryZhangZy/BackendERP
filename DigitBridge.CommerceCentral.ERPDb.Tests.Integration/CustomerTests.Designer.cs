    ...
    public partial class CustomerTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        public static Faker<Customer> GetFakerData()
        {
            ...
            return new Faker<Customer>()
					...
					.RuleFor(u => u.CreditLimit, f => f.Random.Decimal(1, 1000, 6))
					...
					.RuleFor(u => u.OrderMiscAmount, f => f.Random.Decimal(1, 1000, 6))
					.RuleFor(u => u.ItemMiscAmount, f => f.Random.Decimal(1, 1000, 6))
        ...
        {
            var list = DataBaseFactory.Find<Customer>("SELECT TOP 1 * FROM Customer").ToList();
        ...
        {
            //var list = DataBaseFactory.Find<Customer>().ToList();
        ...
        public void AddList_Test()
        {
            ...
            list.SetDataBaseFactory<Customer>(DataBaseFactory)
                .Save<Customer>();
        ...
        public void SaveList_Test()
        {
            ...
            var listFind = DataBaseFactory.Find<Customer>("WHERE Digit_seller_id = @0 ORDER BY RowNum", Digit_seller_id).ToList();
        ...
        {
            var list = (await DataBaseFactory.FindAsync<Customer>()).ToList();
        ...
        public async Task SaveListAsync_Test()
        {
            ...
            var NewCustomerName = Guid.NewGuid().ToString();
            var listFind = (await DataBaseFactory.FindAsync<Customer>("WHERE Digit_seller_id = @0 ORDER BY RowNum", Digit_seller_id)).ToList();
            listFind.ToList().ForEach(x => x.CustomerName = NewCustomerName);
        ...
        {
            var list = (await DataBaseFactory.FindAsync<Customer>("SELECT TOP 1 * FROM Customer")).ToList();
            var data = list.FirstOrDefault();
