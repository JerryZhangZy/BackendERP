...
namespace DigitBridge.CommerceCentral.ERPDb.Tests.Integration
{
    ...
    /// </summary>
    public partial class InventoryDataDtoTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        ...
        public InventoryDataDtoTests(TestFixture<StartupTest> fixture) 
        {
            Fixture = fixture;
        ...
        public void ExportCsv_Test()
        {
            ...
            //var dto = mapper.WriteDto(data, null);
            var fileName = "c:\\temp\\inventoryDto.csv";
            var csvHelper = new InventoryDataDtoCsv();
