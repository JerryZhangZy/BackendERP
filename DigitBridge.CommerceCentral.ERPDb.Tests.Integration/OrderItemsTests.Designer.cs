...
{
    /// <summary>
    /// Represents a Tester for OrderItems.
    /// NOTE: This class is generated from a T4 template - you should not modify it manually.
    /// </summary>
    public partial class OrderItemsTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        public static Faker<OrderItems> GetFakerData()
        {
            #region faker data rules
            return new Faker<OrderItems>()
					...
					.RuleFor(u => u.OrderItemStatus, f => f.Random.Int(1, 100))
        ...
        public Faker<OrderItems> FakerData { get; set; }
        public IDataBaseFactory DataBaseFactory { get; set; }

        public OrderItemsTests(TestFixture<StartupTest> fixture) 
        {
            Fixture = fixture;
		...
		public void Add_Test()
		{
            ...
            var dataGet = DataBaseFactory.GetFromCacheById<OrderItems>(data.UniqueId);
        ...
        {
            var list = DataBaseFactory.Find<OrderItems>("SELECT TOP 1 * FROM OrderItems").ToList();
        ...
        public void Patch_Test()
        {
            ...
            var dataGet = DataBaseFactory.GetFromCache<OrderItems>(data.RowNum);
        ...
        public void Save_Test()
        {
            ...
            var dataUpdate = DataBaseFactory.GetById<OrderItems>(dataNew.UniqueId);
            ...
            var dataGet = DataBaseFactory.GetFromCacheById<OrderItems>(dataUpdate.UniqueId);
        ...
        { 
            ...
            var result = DataBaseFactory.ExistUniqueId<OrderItems>(data.UniqueId);
        ...
        {
            //var list = DataBaseFactory.Find<OrderItems>().ToList();
            //var listData = list.FirstOrDefault();
            //var data = DataBaseFactory.Get<OrderItems>(listData.RowNum);
        ...
        public void GetById_Test()
        {
            var list = DataBaseFactory.Find<OrderItems>("SELECT TOP 1 * FROM OrderItems").ToList();
            var listData = list.FirstOrDefault();
            var data = DataBaseFactory.GetById<OrderItems>(listData.UniqueId);
            var result = data.Equals(listData);
        ...
        public void AddList_Test()
        {
            ...
            list.SetDataBaseFactory<OrderItems>(DataBaseFactory)
                .Save<OrderItems>();

            var cnt = DataBaseFactory.Count<OrderItems>("WHERE OrderUuid = @0", OrderUuid);
        ...
        public void SaveList_Test()
        {
            ...
            var listFind = DataBaseFactory.Find<OrderItems>("WHERE OrderUuid = @0 ORDER BY RowNum", OrderUuid).ToList();
            listFind.ToList().ForEach(x => x.LotNum = NewLotNum);
            listFind.Save<OrderItems>();

            list = DataBaseFactory.Find<OrderItems>("WHERE OrderUuid = @0 ORDER BY RowNum", OrderUuid).ToList();
        ...
        public void GetFromCacheById_Test()
        {
            var list = DataBaseFactory.Find<OrderItems>("SELECT TOP 1 * FROM OrderItems").ToList();
            var data = list.FirstOrDefault();
            var data1 = DataBaseFactory.GetFromCacheById<OrderItems>(data.UniqueId);
            var data2 = DataBaseFactory.GetFromCacheById<OrderItems>(data.UniqueId);
        ...
        public async Task AddAsync_Test()
        {
            ...
            var dataGet = await DataBaseFactory.GetFromCacheByIdAsync<OrderItems>(data.UniqueId);
            var result = data.Equals(dataGet);
        ...
        {
            var list = (await DataBaseFactory.FindAsync<OrderItems>()).ToList();
        ...
        public async Task PatchAsync_Test()
        {
            ...
            var dataGet = await DataBaseFactory.GetFromCacheAsync<OrderItems>(data.RowNum);
            var result = dataGet.SKU != dataOrig.SKU &&
                            dataGet.LotNum != dataOrig.LotNum &&
                            dataGet.SKU == newData.SKU &&
                            dataGet.LotNum == newData.LotNum;
        ...
        public async Task SaveAsync_Test()
        {
            ...
            var dataUpdate = await DataBaseFactory.GetByIdAsync<OrderItems>(dataNew.UniqueId);
            var dataChanged = FakerData.Generate();
            dataUpdate?.CopyFrom(dataChanged, new[] { "OrderItemsUuid" });
            ...
            var dataGet = await DataBaseFactory.GetFromCacheByIdAsync<OrderItems>(dataUpdate.UniqueId);
            var result = dataUpdate.Equals(dataGet);
        ...
        public async Task DeleteAsync_Test()
        {
            ...
            var result = await DataBaseFactory.ExistUniqueIdAsync<OrderItems>(data.UniqueId);
        ...
        public async Task GetAsync_Test()
        {
            var list = (await DataBaseFactory.FindAsync<OrderItems>()).ToList();
            var listData = list.FirstOrDefault();
            var data = await DataBaseFactory.GetAsync<OrderItems>(listData.RowNum);
            var result = data.Equals(listData);
        ...
        public async Task GetByIdAsync_Test()
        {
            var list = (await DataBaseFactory.FindAsync<OrderItems>()).ToList();
            var listData = list.FirstOrDefault();
            var data = await DataBaseFactory.GetByIdAsync<OrderItems>(listData.UniqueId);
            var result = data.Equals(listData);
        ...
        public async Task AddListAsync_Test()
        {
            ...
            list.ForEach(x => x.OrderUuid = OrderUuid);
            await list
                .SetDataBaseFactory<OrderItems>(DataBaseFactory)
                .SaveAsync<OrderItems>();

            var cnt = await DataBaseFactory.CountAsync<OrderItems>("WHERE OrderUuid = @0", OrderUuid);
            var result = cnt.Equals(list.Count());
        ...
        public async Task SaveListAsync_Test()
        {
            ...
            var NewLotNum = Guid.NewGuid().ToString();
            var listFind = (await DataBaseFactory.FindAsync<OrderItems>("WHERE OrderUuid = @0 ORDER BY RowNum", OrderUuid)).ToList();
            listFind.ToList().ForEach(x => x.LotNum = NewLotNum);
            await listFind.SaveAsync<OrderItems>();
        ...
        {
            var list = (await DataBaseFactory.FindAsync<OrderItems>("SELECT TOP 1 * FROM OrderItems")).ToList();
            var data = list.FirstOrDefault();
            var data1 = await DataBaseFactory.GetFromCacheByIdAsync<OrderItems>(data.UniqueId);
            var data2 = await DataBaseFactory.GetFromCacheByIdAsync<OrderItems>(data.UniqueId);
