...
namespace DigitBridge.CommerceCentral.ERPDb.Tests.Integration
{
    ...
    public partial class OrderItemsTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        ...
        {
            var list = DataBaseFactory.Find<OrderItems>();
        ...
        public void SaveList_Test()
        {
            ...
            var listFind = DataBaseFactory.Find<OrderItems>("WHERE OrderUuid = @0 ORDER BY RowNum", OrderUuid);
        ...
        {
            var list = DataBaseFactory.Find<OrderItems>("SELECT TOP 1 * FROM OrderItems");
            var data = list.FirstOrDefault();
        ...
        {
            var list = await DataBaseFactory.FindAsync<OrderItems>();
        ...
        public async Task SaveListAsync_Test()
        {
            ...
            var NewLotNum = Guid.NewGuid().ToString();
            var listFind = await DataBaseFactory.FindAsync<OrderItems>("WHERE OrderUuid = @0 ORDER BY RowNum", OrderUuid);
            listFind.ToList().ForEach(x => x.LotNum = NewLotNum);
        ...
        {
            var list = await DataBaseFactory.FindAsync<OrderItems>("SELECT TOP 1 * FROM OrderItems");
            var data = list.FirstOrDefault();
