...
namespace DigitBridge.CommerceCentral.ERPDb.Tests.Integration
{
    ...
    public partial class OrderHeaderInfoTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        ...
        {
            var list = DataBaseFactory.Find<OrderHeaderInfo>();
        ...
        public void SaveList_Test()
        {
            ...
            var listFind = DataBaseFactory.Find<OrderHeaderInfo>("WHERE ChannelOrderID = @0 ORDER BY RowNum", ChannelOrderID);
        ...
        {
            var list = DataBaseFactory.Find<OrderHeaderInfo>("SELECT TOP 1 * FROM OrderHeaderInfo");
            var data = list.FirstOrDefault();
        ...
        {
            var list = await DataBaseFactory.FindAsync<OrderHeaderInfo>();
        ...
        public async Task SaveListAsync_Test()
        {
            ...
            var NewShippingClass = Guid.NewGuid().ToString();
            var listFind = await DataBaseFactory.FindAsync<OrderHeaderInfo>("WHERE ChannelOrderID = @0 ORDER BY RowNum", ChannelOrderID);
            listFind.ToList().ForEach(x => x.ShippingClass = NewShippingClass);
        ...
        {
            var list = await DataBaseFactory.FindAsync<OrderHeaderInfo>("SELECT TOP 1 * FROM OrderHeaderInfo");
            var data = list.FirstOrDefault();
