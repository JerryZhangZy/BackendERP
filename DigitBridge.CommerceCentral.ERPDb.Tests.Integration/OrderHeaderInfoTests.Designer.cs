...
{
    /// <summary>
    /// Represents a Tester for OrderHeaderInfo.
    /// NOTE: This class is generated from a T4 template - you should not modify it manually.
    /// </summary>
    public partial class OrderHeaderInfoTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        public static Faker<OrderHeaderInfo> GetFakerData()
        {
            #region faker data rules
            return new Faker<OrderHeaderInfo>()
        ...
        public Faker<OrderHeaderInfo> FakerData { get; set; }
        public IDataBaseFactory DataBaseFactory { get; set; }

        public OrderHeaderInfoTests(TestFixture<StartupTest> fixture) 
        {
            Fixture = fixture;
		...
		public void Add_Test()
		{
            ...
            var dataGet = DataBaseFactory.GetFromCacheById<OrderHeaderInfo>(data.UniqueId);
        ...
        {
            var list = DataBaseFactory.Find<OrderHeaderInfo>("SELECT TOP 1 * FROM OrderHeaderInfo").ToList();
        ...
        public void Patch_Test()
        {
            ...
            DataBaseFactory.Begin();
            var data = list.FirstOrDefault();
            var dataOrig = new OrderHeaderInfo();
            ...
            var dataGet = DataBaseFactory.GetFromCache<OrderHeaderInfo>(data.RowNum);
        ...
        public void Save_Test()
        {
            ...
            var dataUpdate = DataBaseFactory.GetById<OrderHeaderInfo>(dataNew.UniqueId);
            ...
            var dataGet = DataBaseFactory.GetFromCacheById<OrderHeaderInfo>(dataUpdate.UniqueId);
        ...
        { 
            ...
            var result = DataBaseFactory.ExistUniqueId<OrderHeaderInfo>(data.UniqueId);
        ...
        {
            //var list = DataBaseFactory.Find<OrderHeaderInfo>().ToList();
            //var listData = list.FirstOrDefault();
            //var data = DataBaseFactory.Get<OrderHeaderInfo>(listData.RowNum);
        ...
        public void GetById_Test()
        {
            var list = DataBaseFactory.Find<OrderHeaderInfo>("SELECT TOP 1 * FROM OrderHeaderInfo").ToList();
            var listData = list.FirstOrDefault();
            var data = DataBaseFactory.GetById<OrderHeaderInfo>(listData.UniqueId);
            var result = data.Equals(listData);
        ...
        public void AddList_Test()
        {
            ...
            list.SetDataBaseFactory<OrderHeaderInfo>(DataBaseFactory)
                .Save<OrderHeaderInfo>();

            var cnt = DataBaseFactory.Count<OrderHeaderInfo>("WHERE ChannelOrderID = @0", ChannelOrderID);
        ...
        public void SaveList_Test()
        {
            ...
            var listFind = DataBaseFactory.Find<OrderHeaderInfo>("WHERE ChannelOrderID = @0 ORDER BY RowNum", ChannelOrderID).ToList();
            listFind.ToList().ForEach(x => x.ShippingClass = NewShippingClass);
            listFind.Save<OrderHeaderInfo>();

            list = DataBaseFactory.Find<OrderHeaderInfo>("WHERE ChannelOrderID = @0 ORDER BY RowNum", ChannelOrderID).ToList();
        ...
        public void GetFromCacheById_Test()
        {
            var list = DataBaseFactory.Find<OrderHeaderInfo>("SELECT TOP 1 * FROM OrderHeaderInfo").ToList();
            var data = list.FirstOrDefault();
            var data1 = DataBaseFactory.GetFromCacheById<OrderHeaderInfo>(data.UniqueId);
            var data2 = DataBaseFactory.GetFromCacheById<OrderHeaderInfo>(data.UniqueId);
        ...
        public async Task AddAsync_Test()
        {
            ...
            var dataGet = await DataBaseFactory.GetFromCacheByIdAsync<OrderHeaderInfo>(data.UniqueId);
            var result = data.Equals(dataGet);
        ...
        {
            var list = (await DataBaseFactory.FindAsync<OrderHeaderInfo>()).ToList();
        ...
        public async Task PatchAsync_Test()
        {
            ...
            var dataGet = await DataBaseFactory.GetFromCacheAsync<OrderHeaderInfo>(data.RowNum);
            var result = dataGet.ShippingCarrier != dataOrig.ShippingCarrier &&
                            dataGet.ShippingClass != dataOrig.ShippingClass &&
                            dataGet.ShippingCarrier == newData.ShippingCarrier &&
                            dataGet.ShippingClass == newData.ShippingClass;
        ...
        public async Task SaveAsync_Test()
        {
            ...
            var dataUpdate = await DataBaseFactory.GetByIdAsync<OrderHeaderInfo>(dataNew.UniqueId);
            var dataChanged = FakerData.Generate();
            dataUpdate?.CopyFrom(dataChanged, new[] { "OrderUuid" });
            ...
            var dataGet = await DataBaseFactory.GetFromCacheByIdAsync<OrderHeaderInfo>(dataUpdate.UniqueId);
            var result = dataUpdate.Equals(dataGet);
        ...
        public async Task DeleteAsync_Test()
        {
            ...
            var result = await DataBaseFactory.ExistUniqueIdAsync<OrderHeaderInfo>(data.UniqueId);
        ...
        public async Task GetAsync_Test()
        {
            var list = (await DataBaseFactory.FindAsync<OrderHeaderInfo>()).ToList();
            var listData = list.FirstOrDefault();
            var data = await DataBaseFactory.GetAsync<OrderHeaderInfo>(listData.RowNum);
            var result = data.Equals(listData);
        ...
        public async Task GetByIdAsync_Test()
        {
            var list = (await DataBaseFactory.FindAsync<OrderHeaderInfo>()).ToList();
            var listData = list.FirstOrDefault();
            var data = await DataBaseFactory.GetByIdAsync<OrderHeaderInfo>(listData.UniqueId);
            var result = data.Equals(listData);
        ...
        public async Task AddListAsync_Test()
        {
            ...
            list.ForEach(x => x.ChannelOrderID = ChannelOrderID);
            await list
                .SetDataBaseFactory<OrderHeaderInfo>(DataBaseFactory)
                .SaveAsync<OrderHeaderInfo>();

            var cnt = await DataBaseFactory.CountAsync<OrderHeaderInfo>("WHERE ChannelOrderID = @0", ChannelOrderID);
            var result = cnt.Equals(list.Count());
        ...
        public async Task SaveListAsync_Test()
        {
            ...
            var NewShippingClass = Guid.NewGuid().ToString();
            var listFind = (await DataBaseFactory.FindAsync<OrderHeaderInfo>("WHERE ChannelOrderID = @0 ORDER BY RowNum", ChannelOrderID)).ToList();
            listFind.ToList().ForEach(x => x.ShippingClass = NewShippingClass);
            await listFind.SaveAsync<OrderHeaderInfo>();
        ...
        {
            var list = (await DataBaseFactory.FindAsync<OrderHeaderInfo>("SELECT TOP 1 * FROM OrderHeaderInfo")).ToList();
            var data = list.FirstOrDefault();
            var data1 = await DataBaseFactory.GetFromCacheByIdAsync<OrderHeaderInfo>(data.UniqueId);
            var data2 = await DataBaseFactory.GetFromCacheByIdAsync<OrderHeaderInfo>(data.UniqueId);
