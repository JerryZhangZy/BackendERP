...
{
    /// <summary>
    /// Represents a Tester for PoHeaderInfo.
    /// NOTE: This class is generated from a T4 template - you should not modify it manually.
    /// </summary>
    public partial class PoHeaderInfoTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        public static Faker<PoHeaderInfo> GetFakerData()
        {
            #region faker data rules
            return new Faker<PoHeaderInfo>()
        ...
        public Faker<PoHeaderInfo> FakerData { get; set; }
        public IDataBaseFactory DataBaseFactory { get; set; }

        public PoHeaderInfoTests(TestFixture<StartupTest> fixture) 
        {
            Fixture = fixture;
		...
		public void Add_Test()
		{
            ...
            var dataGet = DataBaseFactory.GetFromCacheById<PoHeaderInfo>(data.UniqueId);
        ...
        {
            var list = DataBaseFactory.Find<PoHeaderInfo>("SELECT TOP 1 * FROM PoHeaderInfo").ToList();
        ...
        public void Patch_Test()
        {
            ...
            var dataGet = DataBaseFactory.GetFromCache<PoHeaderInfo>(data.RowNum);
        ...
        public void Save_Test()
        {
            ...
            var dataUpdate = DataBaseFactory.GetById<PoHeaderInfo>(dataNew.UniqueId);
            ...
            var dataGet = DataBaseFactory.GetFromCacheById<PoHeaderInfo>(dataUpdate.UniqueId);
        ...
        { 
            ...
            var result = DataBaseFactory.ExistUniqueId<PoHeaderInfo>(data.UniqueId);
        ...
        {
            //var list = DataBaseFactory.Find<PoHeaderInfo>().ToList();
            //var listData = list.FirstOrDefault();
            //var data = DataBaseFactory.Get<PoHeaderInfo>(listData.RowNum);
        ...
        public void GetById_Test()
        {
            var list = DataBaseFactory.Find<PoHeaderInfo>("SELECT TOP 1 * FROM PoHeaderInfo").ToList();
            var listData = list.FirstOrDefault();
            var data = DataBaseFactory.GetById<PoHeaderInfo>(listData.UniqueId);
            var result = data.Equals(listData);
        ...
        public void AddList_Test()
        {
            ...
            list.SetDataBaseFactory<PoHeaderInfo>(DataBaseFactory)
                .Save<PoHeaderInfo>();

            var cnt = DataBaseFactory.Count<PoHeaderInfo>("WHERE ChannelOrderID = @0", ChannelOrderID);
        ...
        public void SaveList_Test()
        {
            ...
            var listFind = DataBaseFactory.Find<PoHeaderInfo>("WHERE ChannelOrderID = @0 ORDER BY RowNum", ChannelOrderID).ToList();
            listFind.ToList().ForEach(x => x.ShippingClass = NewShippingClass);
            listFind.Save<PoHeaderInfo>();

            list = DataBaseFactory.Find<PoHeaderInfo>("WHERE ChannelOrderID = @0 ORDER BY RowNum", ChannelOrderID).ToList();
        ...
        public void GetFromCacheById_Test()
        {
            var list = DataBaseFactory.Find<PoHeaderInfo>("SELECT TOP 1 * FROM PoHeaderInfo").ToList();
            var data = list.FirstOrDefault();
            var data1 = DataBaseFactory.GetFromCacheById<PoHeaderInfo>(data.UniqueId);
            var data2 = DataBaseFactory.GetFromCacheById<PoHeaderInfo>(data.UniqueId);
        ...
        public async Task AddAsync_Test()
        {
            ...
            var dataGet = await DataBaseFactory.GetFromCacheByIdAsync<PoHeaderInfo>(data.UniqueId);
            var result = data.Equals(dataGet);
        ...
        {
            var list = (await DataBaseFactory.FindAsync<PoHeaderInfo>()).ToList();
        ...
        public async Task PatchAsync_Test()
        {
            ...
            var dataGet = await DataBaseFactory.GetFromCacheAsync<PoHeaderInfo>(data.RowNum);
            var result = dataGet.ShippingCarrier != dataOrig.ShippingCarrier &&
                            dataGet.ShippingClass != dataOrig.ShippingClass &&
                            dataGet.ShippingCarrier == newData.ShippingCarrier &&
                            dataGet.ShippingClass == newData.ShippingClass;
        ...
        public async Task SaveAsync_Test()
        {
            ...
            var dataUpdate = await DataBaseFactory.GetByIdAsync<PoHeaderInfo>(dataNew.UniqueId);
            var dataChanged = FakerData.Generate();
            dataUpdate?.CopyFrom(dataChanged, new[] { "PoUuid" });
            ...
            var dataGet = await DataBaseFactory.GetFromCacheByIdAsync<PoHeaderInfo>(dataUpdate.UniqueId);
            var result = dataUpdate.Equals(dataGet);
        ...
        public async Task DeleteAsync_Test()
        {
            ...
            var result = await DataBaseFactory.ExistUniqueIdAsync<PoHeaderInfo>(data.UniqueId);
        ...
        public async Task GetAsync_Test()
        {
            var list = (await DataBaseFactory.FindAsync<PoHeaderInfo>()).ToList();
            var listData = list.FirstOrDefault();
            var data = await DataBaseFactory.GetAsync<PoHeaderInfo>(listData.RowNum);
            var result = data.Equals(listData);
        ...
        public async Task GetByIdAsync_Test()
        {
            var list = (await DataBaseFactory.FindAsync<PoHeaderInfo>()).ToList();
            var listData = list.FirstOrDefault();
            var data = await DataBaseFactory.GetByIdAsync<PoHeaderInfo>(listData.UniqueId);
            var result = data.Equals(listData);
        ...
        public async Task AddListAsync_Test()
        {
            ...
            list.ForEach(x => x.ChannelOrderID = ChannelOrderID);
            await list
                .SetDataBaseFactory<PoHeaderInfo>(DataBaseFactory)
                .SaveAsync<PoHeaderInfo>();

            var cnt = await DataBaseFactory.CountAsync<PoHeaderInfo>("WHERE ChannelOrderID = @0", ChannelOrderID);
            var result = cnt.Equals(list.Count());
        ...
        public async Task SaveListAsync_Test()
        {
            ...
            var NewShippingClass = Guid.NewGuid().ToString();
            var listFind = (await DataBaseFactory.FindAsync<PoHeaderInfo>("WHERE ChannelOrderID = @0 ORDER BY RowNum", ChannelOrderID)).ToList();
            listFind.ToList().ForEach(x => x.ShippingClass = NewShippingClass);
            await listFind.SaveAsync<PoHeaderInfo>();
        ...
        {
            var list = (await DataBaseFactory.FindAsync<PoHeaderInfo>("SELECT TOP 1 * FROM PoHeaderInfo")).ToList();
            var data = list.FirstOrDefault();
            var data1 = await DataBaseFactory.GetFromCacheByIdAsync<PoHeaderInfo>(data.UniqueId);
            var data2 = await DataBaseFactory.GetFromCacheByIdAsync<PoHeaderInfo>(data.UniqueId);
