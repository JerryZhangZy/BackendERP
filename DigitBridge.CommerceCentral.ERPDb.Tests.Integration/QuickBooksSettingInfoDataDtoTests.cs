...
namespace DigitBridge.CommerceCentral.ERPDb.Tests.Integration
{
    ...
    /// </summary>
    public partial class QuickBooksSettingInfoDataDtoTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        ...
        public QuickBooksSettingInfoDataDtoTests(TestFixture<StartupTest> fixture) 
        {
            Fixture = fixture;
		...
		{
            var mapper = new QuickBooksSettingInfoDataDtoMapperDefault();

            var data = GetFakerData();
            var dto = mapper.WriteDto(data, null);
            var data2 = new QuickBooksSettingInfoData();
        ...
        public void ExportCsv_Test()
        {
            ...
            //var dto = mapper.WriteDto(data, null);
            var fileName = "c:\\temp\\_QuickBooksSettingInfoDataDto.csv";
            var csvHelper = new QuickBooksSettingInfoDataDtoCsv();
        ...
        public void ImportCsv_Test()
        {
            var fileName = "c:\\temp\\_QuickBooksSettingInfoDataDto.csv";
            var csvHelper = new QuickBooksSettingInfoDataDtoCsv();
            IList<QuickBooksSettingInfoDataDto> data;
