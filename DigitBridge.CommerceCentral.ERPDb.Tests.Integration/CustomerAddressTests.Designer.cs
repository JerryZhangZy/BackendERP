...
namespace DigitBridge.CommerceCentral.ERPDb.Tests.Integration
{
    ...
    public partial class CustomerAddressTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        ...
        {
            var list = DataBaseFactory.Find<CustomerAddress>();
        ...
        public void SaveList_Test()
        {
            ...
            var listFind = DataBaseFactory.Find<CustomerAddress>("WHERE CustomerUuid = @0 ORDER BY RowNum", CustomerUuid);
        ...
        {
            var list = DataBaseFactory.Find<CustomerAddress>("SELECT TOP 1 * FROM CustomerAddress");
            var data = list.FirstOrDefault();
        ...
        {
            var list = await DataBaseFactory.FindAsync<CustomerAddress>();
        ...
        public async Task SaveListAsync_Test()
        {
            ...
            var NewDescription = Guid.NewGuid().ToString();
            var listFind = await DataBaseFactory.FindAsync<CustomerAddress>("WHERE CustomerUuid = @0 ORDER BY RowNum", CustomerUuid);
            listFind.ToList().ForEach(x => x.Description = NewDescription);
        ...
        {
            var list = await DataBaseFactory.FindAsync<CustomerAddress>("SELECT TOP 1 * FROM CustomerAddress");
            var data = list.FirstOrDefault();
