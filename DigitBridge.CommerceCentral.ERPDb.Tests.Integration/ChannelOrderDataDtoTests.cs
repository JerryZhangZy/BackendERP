...
namespace DigitBridge.CommerceCentral.ERPDb.Tests.Integration
{
    ...
    /// </summary>
    public partial class ChannelOrderDataDtoTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        ...
        public ChannelOrderDataDtoTests(TestFixture<StartupTest> fixture) 
        {
            Fixture = fixture;
		...
		{
            var mapper = new ChannelOrderDataDtoMapperDefault();

            var data = GetFakerData();
            var dto = mapper.WriteDto(data, null);
            var data2 = new ChannelOrderData();
        ...
        public void ExportCsv_Test()
        {
            ...
            //var dto = mapper.WriteDto(data, null);
            var fileName = "c:\\temp\\channelOrderDto.csv";
            var csvHelper = new ChannelOrderDataDtoCsv();
        ...
        public void ImportCsv_Test()
        {
            var fileName = "c:\\temp\\channelOrderDto.csv";
            var csvHelper = new ChannelOrderDataDtoCsv();
            IList<ChannelOrderDataDto> data;
