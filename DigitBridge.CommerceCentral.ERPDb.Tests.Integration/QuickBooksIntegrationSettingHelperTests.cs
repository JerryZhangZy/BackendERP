...
{
    /// <summary>
    /// Represents a Tester for QuickBooksIntegrationSetting Helper.
    /// NOTE: This class is generated from a T4 template Once - you want re-generate it, you need delete cs file and generate again
    /// </summary>
    public partial class QuickBooksIntegrationSettingHelperTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        protected const string SkipReason = "Debug Helper Function";

        protected TestFixture<StartupTest> Fixture { get; }
        public IConfiguration Configuration { get; }
        public Faker<QuickBooksIntegrationSetting> FakerData => QuickBooksIntegrationSettingTests.GetFakerData();
        public IDataBaseFactory DataBaseFactory { get; set; }

        public QuickBooksIntegrationSettingHelperTests(TestFixture<StartupTest> fixture) 
        {
            Fixture = fixture;
        ...
        public void QueryByJson_Test()
        {
            ...
            try
            {
                ...
                using (var b = new Benchmark("QueryByJson_Test"))
                {
                    ...
                    {
                        var rowNum = 0;
                        var dataGet = SqlQuery.QueryJson<QuickBooksIntegrationSetting>(
                            QuickBooksIntegrationSettingHelper.SelectAllWhere(
        ...
        public void QueryBy_Test()
        {
            try
            {
                ...
                using (var b = new Benchmark("QueryByAsync_Test"))
                {
                    ...
                    {
                        var rowNum = 0;
                        var dataGet = SqlQuery.Query<QuickBooksIntegrationSetting>(
                            QuickBooksIntegrationSettingHelper.SelectAllWhere(
                                sqlWhere: $"WHERE RowNum >= @rowNum ORDER BY RowNum OFFSET 0 ROWS FETCH NEXT 10 ROWS ONLY",
                                forJson: false
                            ),
        ...
        public async Task QueryByJsonAsync_Test()
        {
            ...
            try
            {
                ...
                using (var b = new Benchmark("QueryByJsonAsync_Test"))
                {
                    ...
                    {
                        var rowNum = 0;
                        var dataGet = (await SqlQuery.QueryJsonAsync<QuickBooksIntegrationSetting>(
                            QuickBooksIntegrationSettingHelper.SelectAllWhere(
                                sqlWhere: $"WHERE RowNum >= @rowNum ORDER BY RowNum OFFSET 0 ROWS FETCH NEXT 10 ROWS ONLY",
                                forJson: true
                            ),
        ...
        public async Task QueryByAsync_Test()
        {
            try
            {
                ...
                using (var b = new Benchmark("QueryByAsync_Test"))
                {
                    ...
                    {
                        var rowNum = 0;
                        var dataGet = (await SqlQuery.QueryAsync<QuickBooksIntegrationSetting>(
                            QuickBooksIntegrationSettingHelper.SelectAllWhere(
                                sqlWhere: $"WHERE RowNum >= @rowNum ORDER BY RowNum OFFSET 0 ROWS FETCH NEXT 10 ROWS ONLY",
                                forJson: false
                            ),
