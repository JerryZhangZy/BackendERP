...
namespace DigitBridge.CommerceCentral.ERPDb.Tests.Integration
{
    ...
    public partial class CustomerDataTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        public static CustomerData GetFakerData()
        {
			...
			CustomerData.CustomerAddress = CustomerAddressTests.GetFakerData().Generate(); 
			CustomerData.CustomerAttributes = CustomerAttributesTests.GetFakerData().Generate(10); 
			return CustomerData; 
        }
