...
{
    /// <summary>
    /// Represents a Tester for OrderShipmentData.
    /// NOTE: This class is generated from a T4 template - you should not modify it manually.
    /// </summary>
    public partial class OrderShipmentDataTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        public static OrderShipmentData GetFakerData()
        {
			...
			OrderShipmentData.OrderShipmentCanceledItem = OrderShipmentCanceledItemTests.GetFakerData().Generate(10); 
			OrderShipmentData.OrderShipmentPackage = OrderShipmentPackageTests.GetFakerData().Generate(10); 
        ...
        public static List<OrderShipmentData> GetFakerData(int count)
        {
			var OrderShipmentDatas = new List<OrderShipmentData>(); 
			for (int i = 0; i < count; i++) 
				OrderShipmentDatas.Add(GetFakerData()); 
			return OrderShipmentDatas; 
        }
        ...
        public OrderShipmentDataTests(TestFixture<StartupTest> fixture) 
        {
            Fixture = fixture;
...
");
            ...
            var data = new OrderShipmentData(DataBaseFactory);
            data.GetById(id);
		...
		public void Save_Test()
		{
            ...
            var dataGet = new OrderShipmentData(DataBaseFactory);
...
");
            ...
            var data = new OrderShipmentData(DataBaseFactory);
            data.GetById(id);
            var rowNum = data.OrderShipmentHeader.RowNum;
            ...
            var dataGetById = new OrderShipmentData(DataBaseFactory);
