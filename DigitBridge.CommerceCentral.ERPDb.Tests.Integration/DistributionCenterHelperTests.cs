...
{
    /// <summary>
    /// Represents a Tester for DistributionCenter Helper.
    /// NOTE: This class is generated from a T4 template Once - you want re-generate it, you need delete cs file and generate again
    /// </summary>
    public partial class DistributionCenterHelperTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        protected const string SkipReason = "Debug Helper Function";

        protected TestFixture<StartupTest> Fixture { get; }
        public IConfiguration Configuration { get; }
        public Faker<DistributionCenter> FakerData => DistributionCenterTests.GetFakerData();
        public IDataBaseFactory DataBaseFactory { get; set; }

        public DistributionCenterHelperTests(TestFixture<StartupTest> fixture) 
        {
            Fixture = fixture;
