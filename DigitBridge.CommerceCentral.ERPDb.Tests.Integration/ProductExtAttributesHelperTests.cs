...
{
    /// <summary>
    /// Represents a Tester for ProductExtAttributes Helper.
    /// NOTE: This class is generated from a T4 template Once - you want re-generate it, you need delete cs file and generate again
    /// </summary>
    public partial class ProductExtAttributesHelperTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        protected const string SkipReason = "Debug Helper Function";

        protected TestFixture<StartupTest> Fixture { get; }
        public IConfiguration Configuration { get; }
        public Faker<ProductExtAttributes> FakerData => ProductExtAttributesTests.GetFakerData();
        public IDataBaseFactory DataBaseFactory { get; set; }

        public ProductExtAttributesHelperTests(TestFixture<StartupTest> fixture) 
        {
            Fixture = fixture;
        ...
        public void QueryByJson_Test()
        {
            ...
            try
            {
                ...
                using (var b = new Benchmark("QueryByJson_Test"))
                {
                    ...
                    {
                        var rowNum = 0;
                        var dataGet = SqlQuery.QueryJson<ProductExtAttributes>(
                            ProductExtAttributesHelper.SelectAllWhere(
        ...
        public void QueryBy_Test()
        {
            try
            {
                ...
                using (var b = new Benchmark("QueryByAsync_Test"))
                {
                    ...
                    {
                        var rowNum = 0;
                        var dataGet = SqlQuery.Query<ProductExtAttributes>(
                            ProductExtAttributesHelper.SelectAllWhere(
                                sqlWhere: $"WHERE RowNum >= @rowNum ORDER BY RowNum OFFSET 0 ROWS FETCH NEXT 10 ROWS ONLY",
                                forJson: false
                            ),
        ...
        public async Task QueryByJsonAsync_Test()
        {
            ...
            try
            {
                ...
                using (var b = new Benchmark("QueryByJsonAsync_Test"))
                {
                    ...
                    {
                        var rowNum = 0;
                        var dataGet = (await SqlQuery.QueryJsonAsync<ProductExtAttributes>(
                            ProductExtAttributesHelper.SelectAllWhere(
                                sqlWhere: $"WHERE RowNum >= @rowNum ORDER BY RowNum OFFSET 0 ROWS FETCH NEXT 10 ROWS ONLY",
                                forJson: true
                            ),
        ...
        public async Task QueryByAsync_Test()
        {
            try
            {
                ...
                using (var b = new Benchmark("QueryByAsync_Test"))
                {
                    ...
                    {
                        var rowNum = 0;
                        var dataGet = (await SqlQuery.QueryAsync<ProductExtAttributes>(
                            ProductExtAttributesHelper.SelectAllWhere(
                                sqlWhere: $"WHERE RowNum >= @rowNum ORDER BY RowNum OFFSET 0 ROWS FETCH NEXT 10 ROWS ONLY",
                                forJson: false
                            ),
