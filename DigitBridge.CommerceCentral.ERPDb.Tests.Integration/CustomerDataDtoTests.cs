...
namespace DigitBridge.CommerceCentral.ERPDb.Tests.Integration
{
    ...
    /// </summary>
    public partial class CustomerDataDtoTests : IDisposable, IClassFixture<TestFixture<StartupTest>>
    {
        ...
        public CustomerDataDtoTests(TestFixture<StartupTest> fixture) 
        {
            Fixture = fixture;
        ...
        public void ExportCsv_Test()
        {
            ...
            //var dto = mapper.WriteDto(data, null);
            var fileName = "c:\\temp\\customerDto.csv";
            var csvHelper = new CustomerDataDtoCsv();
