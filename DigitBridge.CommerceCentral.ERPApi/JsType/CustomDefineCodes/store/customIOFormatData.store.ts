...
import { CustomIOFormatDataModel, customIOFormatDataInit } from './customIOFormatData.model';
import { isObject, isEqual } from '../../../util';
import { createStoreMobx, StoreMobx } from '../../../store/StoreMobx';

const storeName = 'globalCustomIOFormatDataStore';
const store: StoreMobx = createStoreMobx(storeName, CustomIOFormatDataModel, customIOFormatDataInit);
