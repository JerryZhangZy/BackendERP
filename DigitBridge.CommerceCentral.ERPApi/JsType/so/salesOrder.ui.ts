...
export const salesOrderUi = { 
	...
	ui: {
		...
		//#region UI control for SalesOrderItems
		seq: {
			type: DbComponentEnums.inputTypeEnum.number,
		...
		orderDCAssignmentLineNum: {
			...
			label: 'orderDCAssignmentLineNum',
			placeholder: 'orderDCAssignmentLineNum',
			format: 'number',
			textStyle: {},
		},
		//#endregion UI control for SalesOrderItems
