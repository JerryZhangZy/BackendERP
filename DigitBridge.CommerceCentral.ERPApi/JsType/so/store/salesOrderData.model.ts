...
const SalesOrderHeader = types
	.model('SalesOrderHeader', {
		...
		earliestShipDate: types.optional(types.string, ''),
		latestShipDate: types.optional(types.string, ''),
		signatureFlag: types.optional(types.boolean, false),
		...
		channelAmount: types.optional(types.number, 0),
		...
		depositAmount: types.optional(types.number, 0),
		...
		commissionAmount2: types.optional(types.number, 0),
		commissionAmount3: types.optional(types.number, 0),
		commissionAmount4: types.optional(types.number, 0),
