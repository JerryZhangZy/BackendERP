...
import { OrderShipmentDataModel, orderShipmentDataInit } from './orderShipmentData.model';
import { isObject, isEqual } from '../../../util';
import { createStoreMobx, StoreMobx } from '../../../store/StoreMobx';

const storeName = 'globalOrderShipmentDataStore';
const store: StoreMobx = createStoreMobx(storeName, OrderShipmentDataModel, orderShipmentDataInit);
