...
import { InventoryUpdateDataModel, inventoryUpdateDataInit } from './inventoryUpdateData.model';
import { isObject, isEqual } from '../../../util';
import { createStoreMobx, StoreMobx } from '../../../store/StoreMobx';

const storeName = 'globalInventoryUpdateDataStore';
const store: StoreMobx = createStoreMobx(storeName, InventoryUpdateDataModel, inventoryUpdateDataInit);
