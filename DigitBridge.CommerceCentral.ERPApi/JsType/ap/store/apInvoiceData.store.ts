...
import { ApInvoiceDataModel, apInvoiceDataInit } from './apInvoiceData.model';
import { isObject, isEqual } from '../../../util';
import { createStoreMobx, StoreMobx } from '../../../store/StoreMobx';

const storeName = 'globalApInvoiceDataStore';
const store: StoreMobx = createStoreMobx(storeName, ApInvoiceDataModel, apInvoiceDataInit);
