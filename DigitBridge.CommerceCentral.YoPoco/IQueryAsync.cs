...
namespace DigitBridge.CommerceCentral.YoPoco
{
    public interface IQueryAsync
    {
        ...
        Task QueryAsync<T>(Action<T> receivePocoCallback, CancellationToken cancellationToken, CommandType commandType, IEnumerable<string> tableColumns, string sql, params object[] args);
        ...
        Task<IAsyncReader<T>> QueryAsync<T>(IEnumerable<string> tableColumns, string sql, params object[] args);
        ...
        Task<IAsyncReader<T>> QueryAsync<T>(CancellationToken cancellationToken, CommandType commandType, IEnumerable<string> tableColumns, string sql, params object[] args);
        ...
        Task<List<T>> FetchAsync<T>(IEnumerable<string> tableColumns, string sql, params object[] args);
        ...
        Task<List<T>> FetchAsync<T>(CancellationToken cancellationToken, CommandType commandType, IEnumerable<string> tableColumns, string sql, params object[] args);
        ...
        Task<bool> ExistUniqueIdAsync<T>(object uniqueKey);
        Task<bool> ExistUniqueIdAsync<T>(CancellationToken cancellationToken, object uniqueKey);
        ...
        /// </summary>
        Task<T> SingleOrDefaultAsync<T>(object primaryKey, bool isUniqueKey = false);
        Task<T> SingleOrDefaultAsync<T>(IEnumerable<string> tableColumns, object primaryKey, bool isUniqueKey = false);

        /// <summary>
        ///     Async version of <see cref="IQuery.SingleOrDefault{T}(object)" />.
        /// </summary>
        Task<T> SingleOrDefaultAsync<T>(CancellationToken cancellationToken, object primaryKey, bool isUniqueKey = false);
        Task<T> SingleOrDefaultAsync<T>(CancellationToken cancellationToken, IEnumerable<string> tableColumns, object primaryKey, bool isUniqueKey = false);
