...
namespace DigitBridge.CommerceCentral.YoPoco
{
    ...
    public class SqlTableInfo
    {
        ...
        public bool HasForeignKey => ForeignKey != null && ForeignKey.Count > 0;
        ...
        public bool HasParent => Parent != null && !string.IsNullOrEmpty((Parent.Name));
        public List<SqlTableInfo> oneToOneChildren { get; set; }
        public bool HasChildren { get { return oneToOneChildren != null && oneToOneChildren.Count > 0; } }
        public bool OneToOne { get; set; }
    }
    ...
    public class SqlColumnInfo
    {
        ...
        {
            get { return (Type == "string" && Length == "max"); }
        }
    ...
    public class SQLFileParser
    {
        ...
        public StructureInfo GetStructure()
        {
            ...
            foreach (var stu in Structure.StructureTables)
            {
                ...
                stuTb.Table.OneToOne = stuTb.OneToOne;
                if (stuTb.MainTable)
