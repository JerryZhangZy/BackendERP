...
namespace DigitBridge.CommerceCentral.YoPoco
{
    public interface IAlterPoco
    {
        ...
        /// <param name="tableColumns">Ignore columns name list</param>
        /// <returns>The auto allocated primary key of the new record, or null for non-auto-increment tables.</returns>
        object Insert(string tableName, object poco, IEnumerable<string> tableColumns = null);
        ...
        /// <param name="tableColumns">Ignore columns name list</param>
        /// <returns>The auto allocated primary key of the new record, or null for non-auto-increment tables.</returns>
        object Insert(string tableName, string primaryKeyName, object poco, IEnumerable<string> tableColumns = null);
        ...
        /// </remarks>
        object Insert(string tableName, string primaryKeyName, bool autoIncrement, object poco, IEnumerable<string> tableColumns = null);
        ...
        /// </remarks>
        object Insert(object poco, IEnumerable<string> tableColumns = null);
        ...
        int Update(string tableName, string primaryKeyName, object poco, object primaryKeyValue, IEnumerable<string> columns, IEnumerable<string> tableColumns = null);
        ...
        /// <param name="poco">The POCO object that specifies the column values to be updated</param>
        /// <param name="columns">The column names of the columns to be updated, or null for all</param>
        /// <param name="tableColumns">Database table column names, or null for all</param>
        /// <returns>The number of affected rows</returns>
        int UpdateColumns(object poco, IEnumerable<string> columns, IEnumerable<string> tableColumns);
        ...
        /// <param name="poco">The POCO object that specifies the column values to be updated</param>
        /// <param name="tableColumns">Database table column names, or null for all</param>
        /// <param name="ignoreUpdateColumns">Ignore update column names, or null for all</param>
        /// <returns>The number of affected rows</returns>
        int UpdateWithIgnore(object poco, IEnumerable<string> tableColumns, IEnumerable<string> ignoreUpdateColumns = null);
        ...
        /// <param name="primaryKeyValue">The primary key of the record to be updated</param>
        /// <param name="columns">The column names of the columns to be updated, or null for all</param>
        /// <param name="tableColumns">The column names of the columns to ignore updated, or null for all</param>
        /// <returns>The number of affected rows</returns>
        int Update(object poco, object primaryKeyValue, IEnumerable<string> columns, IEnumerable<string> tableColumns = null, IEnumerable<string> ignoreUpdateColumns = null);
