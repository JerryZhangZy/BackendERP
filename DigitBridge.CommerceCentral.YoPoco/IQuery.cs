...
namespace DigitBridge.CommerceCentral.YoPoco
{
    public interface IQuery
    {
        ...
        /// </summary>
        /// <typeparam name="T">The Type representing a row in the result set</typeparam>
        /// <param name="tableColumns">Database table Columns name list</param>
        /// <returns>An enumerable collection of POCOs</returns>
        /// <remarks>
        ///     For some DB providers, care should be taken to not start a new Query before finishing with
        ///     and disposing the previous one. In cases where this is an issue, consider using Fetch, which
        ///     returns the results as a List rather than an IEnumerable.
        /// </remarks>
        IEnumerable<T> Query<T>(IEnumerable<string> tableColumns);
        IEnumerable<T> Query<T>(IEnumerable<string> tableColumns, string sql, params object[] args);
        ...
        /// <summary>
        ///     Checks for the existence of a row with the specified unique key value.
        /// </summary>
        /// <typeparam name="T">The Type representing the table being queried</typeparam>
        /// <param name="uniqueKey">The unique key value to look for</param>
        /// <returns>True if a record with the specified primary key value exists.</returns>
        bool ExistsUniqueId<T>(object uniqueKey);
        ...
        /// </remarks>
        T Single<T>(object primaryKey, bool isUniqueKey = false);
        ...
        /// </remarks>
        T SingleOrDefault<T>(object primaryKey, bool isUniqueKey = false);
        ...
        /// </summary>
        /// <typeparam name="T">The Type representing a row in the result set</typeparam>
        /// <param name="tableColumns">Database table column name list</param>
        /// <param name="primaryKey">The primary key value of the record to fetch</param>
        /// <returns>The single record matching the specified primary key value</returns>
        /// <remarks>
        ///     If there are no records with the specified primary key value, default(T) (typically null) is returned.
        /// </remarks>
        T SingleOrDefault<T>(IEnumerable<string> tableColumns, object primaryKey, bool isUniqueKey = false);
        ...
        /// <param name="args">Arguments to any embedded parameters in the SQL statement</param>
        /// <returns>The first record in the result set, or default(T) if no matching rows</returns>
        T FirstOrDefault<T>(IEnumerable<string> tableColumns, string sql, params object[] args);
