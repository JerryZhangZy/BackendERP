...
namespace DigitBridge.CommerceCentral.YoPoco
{
    ...
    public interface IMapper
    {
        ...
        /// </remarks>
        ColumnInfo GetColumnInfo(MemberInfo pocoProperty);
        ...
        Func<object, object> GetFromDbConverter(MemberInfo targetProperty, Type sourceType);
        ...
        /// </remarks>
        Func<object, object> GetToDbConverter(MemberInfo sourceProperty);
    }
}