...
namespace DigitBridge.CommerceCentral.YoPoco
{
    ...
    {
        /// <summary>
        ///     Inspect mapping Poco Object fields to data table
        /// </summary>
        public bool IsMappingFields { get; set; }

        /// <summary>
        ///     Gets or sets the get sequence name logic.
        /// </summary>
        public Func<Type, MemberInfo, string> GetSequenceName { get; set; }
        ...
        /// </summary>
        public Func<ColumnInfo, Type, MemberInfo, bool> MapColumn { get; set; }
        ...
        /// <summary>
        ///     Gets or set the map unique Id logic.
        /// </summary>
        public Func<TableInfo, Type, bool> MapUniqueId { get; set; }
        ...
        /// </summary>
        public Func<MemberInfo, Type, Func<object, object>> FromDbConverter { get; set; }

        /// <summary>
        ///     Gets or sets the to db converter logic.
        /// </summary>
        public Func<MemberInfo, Func<object, object>> ToDbConverter { get; set; }
        ...
        public ConventionMapper()
        {
            ...
            MapUniqueId = (ti, t) =>
            {
                TableInfo.PopulateUniqueIdFromPoco(t, ref ti, out var pkAttr);
                return (pkAttr != null);
            };
            MapTable = (ti, t) =>
            {
        ...
        /// </summary>
        /// <param name="pocoProperty">The MemberInfo of the property being queried</param>
        /// <returns>A reference to a ColumnInfo instance, or null to ignore this property</returns>
        /// <remarks>
        ///     To create a ColumnInfo from a property's attributes, use MemberInfo.FromProperty
        /// </remarks>
        public virtual ColumnInfo GetColumnInfo(MemberInfo pocoProperty)
        {
        ...
        public virtual Func<object, object> GetFromDbConverter(MemberInfo targetProperty, Type sourceType)
        {
        ...
        /// </remarks>
        public virtual Func<object, object> GetToDbConverter(MemberInfo sourceProperty)
        {
