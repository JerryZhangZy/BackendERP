...
namespace DigitBridge.CommerceCentral.YoPoco
{
    ...
    public class ColumnInfo
    {
        ...
        internal static void PopulateFromProperty(MemberInfo pi, ref ColumnInfo ci, out ColumnAttribute columnAttr)
        {
        ...
        /// </summary>
        /// <param name="MemberInfo">The property whose column info is required</param>
        /// <returns>A ColumnInfo instance</returns>
        public static ColumnInfo FromProperty(MemberInfo MemberInfo)
        {
            var ci = new ColumnInfo();
            PopulateFromProperty(MemberInfo, ref ci, out _);
            return ci;
        }
    }
}